$(document).ready(function() {
    ...
    //=======FILTER=======//
    $(document).on("change", "#jenis, #merk, #pabrik, #lokasi, #area, #kondisi, #idle, .isSelectAllPlant", function() {
        datatables_ssp();
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(i, v) {
                    ...
                    //sticker label
                    if (v.sticker_label == 'y') {
                        $("input[name='sticker_label']").attr('checked');
                        $("input[name='sticker_label']").bootstrapToggle('on');
                    } else {
                        $("input[name='sticker_label']").removeAttr('checked');
                        $("input[name='sticker_label']").bootstrapToggle('off');
                    }
