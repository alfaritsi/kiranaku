...
$(document).ready(function () {
    ...
    $(document).on("click", "button[name='action_btn']", function (e) {
        var empty_form = validate('.form-master-pic_sync', true);
        if (empty_form == 0) {
            var isproses = $("input[name='isproses']").val();
            if (isproses == 0) {
                var formData = new FormData($(".form-master-pic_sync")[0]);
                $.ajax({
                    url: baseURL + 'travel/master/save/pic_sync',
                    type: 'POST',
                    dataType: 'JSON',
                    data: formData,
                    contentType: false,
    ...
    $(document).on("click", ".edit", function (e) {
        ...
        $.ajax({
            url: baseURL + 'travel/master/get/pic_sync_detail',
            type: 'POST',
            dataType: 'JSON',
            data: {
                dataedit: data_sync
            ...
            success: function (data) {
                ...
                id_pic_sync = data.nik + '|' + data.company_code + '|' + data.personal_area + '|' + data.jns_user;
                ...
                $("input[name='id_pic_sync']").val(id_pic_sync);
        ...
        kiranaConfirm(
            {
                ...
                successCallback: function () {
                    $.ajax({
                        url: baseURL + 'travel/master/set/pic_sync',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id,
...
function datatables_ssp() {
    ...
    $("#sspTable").dataTable({
        ...
        serverSide: true,
        ajax: {
            url: baseURL + 'travel/master/travel_pic_sync',
            type: 'POST',
            data: {
                filterbom: "bom",
        ...
        columns: [
            ...
            {
                "data": "id_travel_pic_sync",
                "name": "id_travel_pic_sync",
                "width": "8%",
                "render": function (data, type, row) {
                    var action = "";
