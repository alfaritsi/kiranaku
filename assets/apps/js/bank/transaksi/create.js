$(document).ready(function() {
    ...
    $(document).on("change", "#jenis_pengajuan", function(e){
		...
		if(jenis_pengajuan=='pembukaan'){
			...
			$("select[name='tujuan_old']").prop('required', false);
			...
			$("select[name='pendamping_old[]']").prop('required', false);
			$("select[name='pendamping_new[]']").prop('required', false);
			//set not mandatory
    ...
    $(document).on("click", "#reset_btn", function (e) {
		alert('aa');
		resetForm_use($('.form-bank-create'));
...
function resetForm_use($form, $act) {
	...
	$("#pabrik").val(0).trigger("change");
	//pembukaan
	$("#mata_uang").val(0).trigger("change");
	$("#tujuan").val(0).trigger("change");
	$("#prioritas1").val('').trigger("change");
	$("#prioritas2").val('').trigger("change");
	$("#pendamping").val('').trigger("change");
	//penutupan
	$("#id_data_tujuan").val('').trigger("change");
	$("#id_data").val('').trigger("change");
	//perubahan
	$("#tujuan_new").val('').trigger("change");
	$("#tujuan_detail_new").val('').trigger("change");
	$("#prioritas1_new").val('').trigger("change");
	$("#prioritas2_new").val('').trigger("change");
	$("#pendamping_new").val('').trigger("change");
    validateReset($form);
}
