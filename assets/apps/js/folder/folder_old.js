...
$(document).ready(function() {
	...
	$(document).on("dblclick", ".datatable-folder tr", function(e){
    	...
    	if (tipe == 'docx' ||tipe == 'doc' || tipe == 'xls' || tipe == 'xlsx' || tipe == 'swf' || tipe == 'vsd') {
    		...
    		$.ajax({
				...
				success: function(data){
					 window.open(baseURL+'assets/'+data.link , '_blank');
				}
			});
    	}
	...
	*/
	...
	$(document).on("change", "#divisi_write", function(){
	    ...
	    $("#department_write").val(null).trigger('change');
	    $("#level_write").val(null).trigger('change');
	...
	$(document).on("change", "#divisi_read", function(){
	    ...
	    $("#department_read").val(null).trigger('change');
	    $("#level_akses").val(null).trigger('change');
