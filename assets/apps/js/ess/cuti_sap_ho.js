$(document).ready(function(){
    $(document).on('click','#btn-sync-sap-ho-nik',function(e){
        swal({
            input: 'number',
    ...
    $(document).on('click', '[name="reset_btn"]', function (e) {
        e.preventDefault();
        var form = $('form[name="form-batal-cutiijin"]:visible');
        form[0].reset();
    });

    $('#btn-sync-sap-ho').on('click',function(e){
        e.preventDefault();
