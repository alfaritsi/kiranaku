...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
			$.each(data, function (i, v) {
				...
				$("input[name='status_akhir']").val(v.status_realisasi);
                ...
                if (v.arr_data_sdm) {
					...
					$.each(v.arr_data_sdm, function(a, b){
						...
						output += "	<td>";
						output += "		<select class='form-control input-control select2' name='sdm_status_aktual[]' data-placeholder='Pilih Status' required='required'>";
						output += "			<option></option>";
						output += "			<option value='mutasi'>Mutasi</option>";
						output += "			<option value='rotasi'>Rotasi</option>";
						output += "			<option value='promosi'>Promosi</option>";
						...
						output += "	</td>";
						output += "	<td>";
						output += "		<select class='form-control input-control select2' name='sdm_lokasi_aktual[]' data-placeholder='Pilih Lokasi'  required='required'>";
						output += "			<option></option>";
						output += "			<option value='pabrik'>Pabrik</option>";
						output += "			<option value='depo'>Depo</option>";
						output += "		</select>";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control input-control tanggal' name='sdm_tanggal_aktual[]' value='"+b.tanggal_aktual_format+"' placeholder='Tanggal'  required='required'/>";
						output += "	</td>";
						output += "</tr>";
						...
						$(elem+ " select[name='sdm_status_aktual[]']").val(b.status_aktual).trigger("change.select2");
						$(elem+ " select[name='sdm_lokasi_aktual[]']").val(b.lokasi_aktual).trigger("change.select2");
						
						//set select2	
						$("select[name='id_biaya_sdm[]']").select2();
						$("select[name='sdm_status_rencana[]']").select2();
						$("select[name='sdm_lokasi_rencana[]']").select2();
						$("select[name='sdm_status_aktual[]']").select2();
						$("select[name='sdm_lokasi_aktual[]']").select2();
                ...
                if (v.arr_data_asset) {
					...
					$.each(v.arr_data_asset, function(a, b){
						...
						output += "	<td>";
						output += "		<select class='form-control input-control select2' name='asset_status_aktual[]' data-placeholder='Pilih Keterangan' required='required'>";
						output += "			<option></option>";
						output += "			<option value='mutasi'>Mutasi</option>";
						output += "			<option value='disposal'>Disposal</option>";
						output += "		</select>";
						output += "	</td>";
						output += "	<td>";
						output += "		<select class='form-control input-control select2' name='asset_lokasi_aktual[]' data-placeholder='Pilih Lokasi' required='required'>";
						output += "			<option></option>";
						output += "			<option value='pabrik'>Pabrik</option>";
						output += "			<option value='depo'>Depo</option>";
						output += "		</select>";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control input-control tanggal' name='asset_tanggal_aktual[]' value='"+b.tanggal_aktual_format+"' placeholder='Tanggal'  required='required'/>";
						output += "	</td>";
						output += "</tr>";
						...
						$(elem+ " select[name='asset_status_aktual[]']").val(b.status_aktual).trigger("change.select2");
						$(elem+ " select[name='asset_lokasi_aktual[]']").val(b.lokasi_aktual).trigger("change.select2");
						
						//set select2
						$("select[name='asset_status_rencana[]']").select2();
						$("select[name='asset_lokasi_rencana[]']").select2();
						$("select[name='asset_status_aktual[]']").select2();
						$("select[name='asset_lokasi_aktual[]']").select2();
						$('.tanggal').datepicker({
							format: 'dd.mm.yyyy',
							autoclose: true
						});
                ...
                if (v.arr_data_keuangan) {
					...
					$.each(v.arr_data_keuangan, function(a, b){
						...
						let val_keuangan_penyelesaian_aktual = (b.penyelesaian_aktual>0)?numberWithCommas(parseFloat(b.penyelesaian_aktual).toFixed(0)):'';
						let val_keuangan_tanggal_aktual = (b.tanggal_aktual_format!='01.01.1970')?b.tanggal_aktual_format:'';
						...
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='angka form-control input-control text-right' name='keuangan_penyelesaian_aktual[]' value='"+val_keuangan_penyelesaian_aktual+"'/>";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control input-control tanggal' name='keuangan_tanggal_aktual[]' value='"+val_keuangan_tanggal_aktual+"' />";
						output += "	</td>";
						output += "</tr>";
                ...
                if (v.arr_data_bokar) {
					$.each(v.arr_data_bokar, function(a, b){
						...
						if(b.penyelesaian_aktual>0){
							$("input[name='bokar_penyelesaian_aktual']").val(numberWithCommas(parseFloat(b.penyelesaian_aktual).toFixed(2)));
						}else{
							$("input[name='bokar_penyelesaian_aktual']").val('');
						}
						if(b.bokar_tanggal_aktual>0){
							$("input[name='bokar_tanggal_aktual']").val(b.tanggal_aktual_format);
						}else{
							$("input[name='bokar_tanggal_aktual']").val('');
						}
                ...
                if (v.arr_data_lain) {
					...
					$.each(v.arr_data_lain, function(a, b){
						...
						output += "	<td>";
						output += "		<input type='text' class='form-control input-control angka' name='lain_penyelesaian_aktual[]' value='"+numberWithCommas(parseFloat(b.penyelesaian_aktual).toFixed(0))+"' placeholder='Penyelesaian'  required='required'/>";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control input-control tanggal' name='lain_tanggal_aktual[]' value='"+b.tanggal_aktual_format+"' placeholder='Tanggal'  required='required'/>";
						output += "	</td>";
						output += "</tr>";
        ...
        complete: function () {
			$('#form_realisasi_penutupan_depo_detail .form-control').prop('disabled', true);
			$('#form_realisasi_penutupan_depo_detail .btn').prop('disabled', true);
			$('#form_realisasi_penutupan_depo_detail .btn-primary').hide();
			$('#form_realisasi_penutupan_depo_detail .btn-warning').hide();
			$('#form_realisasi_penutupan_depo_detail .btn-default').prop('disabled', false);
			
			//control button approve/decline		
			$('#form_realisasi_penutupan_depo_detail #btn_decline').hide();
			let status_akhir = $("#form_realisasi_penutupan_depo_detail input[name='status_akhir']").val();
			let level 		 = $("#form_realisasi_penutupan_depo_detail input[name='level']").val();
			if(status_akhir!=1){
				if(status_akhir==999){
					$('#btn_decline').hide();
				}else{
	...
	//save approve
    $(document).on("click", "#save_form_action_realisasi_penutupan_depo", function(e) {
        var empty_form = validate('#form_save_realisasi_penutupan_depo');
        if (empty_form == 0) {
            var isproses = $("input[name='isproses']").val();
            if (isproses == 0) {
				$("input[name='isproses']").val(1);
				var formData = new FormData($("#form_save_realisasi_penutupan_depo")[0]);
				$.ajax({
					url: baseURL + 'depo/realisasi/save/approve',
					type: 'POST',
					dataType: 'JSON',
					data: formData,
					contentType: false,
					...
					success: function(data) {
						if (data.sts == 'OK') {
							swal('Success', data.msg, 'success').then(function() {
								window.location = baseURL + 'depo/realisasi/approve';
							});
						} else {
...
function generate_modal_action(elem) {
    ...
    let jenis_depo 	 = $("#form_realisasi_penutupan_depo_detail input[name='jenis_depo']").val();
    let nomor 		 = $("#form_realisasi_penutupan_depo_detail input[name='nomor']").val();
    let status_akhir = $("#form_realisasi_penutupan_depo_detail input[name='status_akhir']").val();
    let id_depo_master = $("#form_realisasi_penutupan_depo_detail input[name='id_depo_master']").val();
    let action 		 = elem.val();
    switch (action) {
        case "approve":
    ...
    $("#KiranaModals .modal-title").html(action + " Realisasi Penutupan Depo (" + nomor + ")");

    let output = '';
    output += '<div class="row">';
    output += ' <div class="col-sm-12">';
    output += '     <form role="form" id="form_save_realisasi_penutupan_depo">';
    output += '         <div class="form-group">';
    output += '             <label>Komentar</label>';
    output += '             <textarea class="form-control" name="komentar_realisasi" required="required"></textarea>';
    ...
    if (action == 'approve') {
        $("#KiranaModals textarea[name='komentar_realisasi']").removeAttr("required");
    } else {
        $("#KiranaModals textarea[name='komentar_realisasi']").attr("required", "required");
    }

    let output_footer = '';
    output_footer += '<div class="modal-footer">';
	if(action=='approve')
    output_footer += '  <button type="button" class="btn btn-primary" id="save_form_action_realisasi_penutupan_depo">Approve</button>';
	if(action=='decline')
    output_footer += '  <button type="button" class="btn btn-danger" id="save_form_action_realisasi_penutupan_depo">Decline</button>';
    output_footer += '</div>';
