$(document).ready(function() {
    ...
    $(document).on("click", ".history", function() {
        ...
        $.ajax({
			url: baseURL + 'depo/penutupan/get/history',
            type: 'POST',
            dataType: 'JSON',
            data: {
                nomor: nomor
...
function datatables_ssp() {
    ...
    var mydDatatables = $("#sspTable").DataTable({
        ...
        ajax: {
            ...
            url: baseURL + 'depo/penutupan/get/data/bom',
            type: 'POST',
            data: function(data) {
        ...
        columns: [
            ...
            },
            {
                ...
                "width": "5%",
                "render": function(data, type, row) {
					var url_edit 	= baseURL + "depo/penutupan/edit/" + row.nomor_format;
					var url_detail 	= baseURL + "depo/penutupan/detail/" + row.nomor_format;
