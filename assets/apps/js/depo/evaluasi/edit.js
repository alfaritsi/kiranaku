...
$(document).ready(function () {
    $.ajax({
			...
			$.each(data, function (i, v) {
                ...
                if (v.arr_data_detail) {
					...
					$.each(v.arr_data_detail, function(a, b){
						...
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='bulan_tahun[]' value='"+b.bulan+"-"+b.tahun+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='target[]' value='"+numberWithCommas(parseFloat(b.target).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='aktual_kering[]' value='"+numberWithCommas(parseFloat(b.aktual_kering).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='aktual_basah[]' value='"+numberWithCommas(parseFloat(b.aktual_basah).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='harga_notarin[]' value='"+numberWithCommas(parseFloat(b.harga_notarin).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='sicom[]' value='"+numberWithCommas(parseFloat(b.sicom).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='biaya_pabrik[]' value='"+numberWithCommas(parseFloat(b.biaya_pabrik).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='harga_beli_depo[]' value='"+numberWithCommas(parseFloat(b.harga_beli_depo).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='susut_pabrik[]' value='"+numberWithCommas(parseFloat(b.susut_pabrik).toFixed(2))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='harga_beli_batch_pabrik[]' value='"+numberWithCommas(parseFloat(b.harga_beli_batch_pabrik).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='susut_depo[]' value='"+numberWithCommas(parseFloat(b.susut_depo).toFixed(2))+"' readonly />";
						output += "	</td>";
						output += "	<td>";
						output += "		<input type='text' class='form-control text-center' name='harga_beli_batch_depo[]' value='"+numberWithCommas(parseFloat(b.harga_beli_batch_depo).toFixed(0))+"' readonly />";
						output += "	</td>";
						output += "</tr>";
					});
                ...
                if (v.arr_data_biaya) {
					...
					$.each(v.arr_data_biaya, function(a, b){
						...
						if((b.id_evaluasi_biaya==1)||(b.id_evaluasi_biaya==2)){
							...
							output_operasional += "<tr class='row-biaya_profesional biaya_profesional" + b.id_biaya + "'>";
							output_operasional += "	<td>";
							output_operasional += "		<input type='text' class='form-control' name='nama_biaya_profesional[]' value='"+b.nama+"' placeholder='Biaya'  required='required' />";
							output_operasional += "		<input type='hidden' class='angka form-control form-control-input text-center' name='id_evaluasi_biaya_profesional[]' value='"+b.id_evaluasi_biaya+"'/>";
							output_operasional += "		<input type='hidden' class='angka form-control form-control-input text-center' name='biaya_kgb_pembukaan[]' value='"+b.biaya_kgb_pembukaan+"'/>";
							output_operasional += "	</td>";
							output_operasional += "	<td>";
							output_operasional += "		<input type='text' class='angka form-control form-control-input text-center' name='biaya_profesional_kgb[]' value='"+numberWithCommas(parseFloat(biaya_kgb).toFixed(0))+"' placeholder='Biaya'/>";
							output_operasional += "		<input type='hidden' class='angka form-control form-control-input text-center' name='drc_rata_rata[]' value='"+parseFloat(drc_rata_rata)+"' placeholder='Biaya'/>";
							output_operasional += "	</td>";
							output_operasional += "	<td>";
							output_operasional += "		<input type='text' class='angka form-control text-center' name='biaya_profesional_kgk[]' value='"+numberWithCommas(parseFloat(biaya_kgb/drc_rata_rata).toFixed(0))+"' placeholder='Biaya'/>";
							output_operasional += "	</td>";
							output_operasional += "</tr>";
						}
						//opex
						if(b.id_evaluasi_biaya==3){
							output_opex += "<tr class='row-biaya_opex biaya_opex" + b.id_biaya + "'>";
							output_opex += "	<td>";
							output_opex += "		<input type='text' class='form-control' name='nama_biaya_opex' value='"+b.nama+"' placeholder='Biaya'  required='required' />";
							output_opex += "		<input type='hidden' class='angka form-control form-control-input text-center' name='id_evaluasi_biaya_opex' value='"+b.id_evaluasi_biaya+"'/>";							
							output_opex += "		<input type='hidden' class='angka form-control form-control-input text-center' name='biaya_kgb_pembukaan[]' value='"+b.biaya_kgb_pembukaan+"'/>";
							output_opex += "	</td>";
							output_opex += "	<td>";
							output_opex += "		<input type='text' class='angka form-control form-control-input text-center' name='biaya_opex_kgb' value='"+numberWithCommas(parseFloat(biaya_kgb).toFixed(0))+"' placeholder='Biaya'/>";
							output_opex += "		<input type='hidden' class='angka form-control form-control-input text-center' name='drc_rata_rata[]' value='"+parseFloat(drc_rata_rata)+"' placeholder='Biaya'/>";
							output_opex += "	</td>";
							output_opex += "	<td>";
							output_opex += "		<input type='text' class='angka form-control text-center' name='biaya_opex_kgk[]' value='"+numberWithCommas(parseFloat(biaya_kgb/drc_rata_rata).toFixed(0))+"' placeholder='Biaya'/>";
							output_opex += "	</td>";
							output_opex += "</tr>";
						}
						//angkut
						if(b.id_evaluasi_biaya==4){
							output_angkut += "<tr class='row-biaya_angkut biaya_angkut" + b.id_biaya + "'>";
							output_angkut += "	<td>";
							output_angkut += "		<input type='text' class='form-control' name='nama_biaya_angkut' value='"+b.nama+"' placeholder='Biaya'  required='required' />";
							output_angkut += "		<input type='hidden' class='angka form-control form-control-input text-center' name='id_evaluasi_biaya_angkut' value='"+b.id_evaluasi_biaya+"'/>";
							output_angkut += "		<input type='hidden' class='angka form-control form-control-input text-center' name='biaya_kgb_pembukaan[]' value='"+b.biaya_kgb_pembukaan+"'/>";
							output_angkut += "	</td>";
							output_angkut += "	<td>";
							output_angkut += "		<input type='text' class='angka form-control form-control-input text-center' name='biaya_angkut_kgb' value='"+numberWithCommas(parseFloat(biaya_kgb).toFixed(0))+"' placeholder='Biaya'/>";
							output_angkut += "		<input type='hidden' class='angka form-control form-control-input text-center' name='drc_rata_rata[]' value='"+parseFloat(drc_rata_rata)+"' placeholder='Biaya'/>";
							output_angkut += "	</td>";
							output_angkut += "	<td>";
							output_angkut += "		<input type='text' class='angka form-control text-center' name='biaya_angkut_kgk[]' value='"+numberWithCommas(parseFloat(biaya_kgb/drc_rata_rata).toFixed(0))+"' placeholder='Biaya'/>";
							output_angkut += "	</td>";
							output_angkut += "</tr>";
						}
						//gaji
						if((b.id_evaluasi_biaya==5)||(b.id_evaluasi_biaya==6)){
							...
							output_gaji += "<tr class='row-biaya_gaji biaya_gaji" + b.id_biaya + "'>";
							output_gaji += "	<td>";
							output_gaji += "		<input type='text' class='form-control' name='nama_biaya_gaji[]' value='"+b.nama+"' placeholder='Biaya'  required='required' />";
							output_gaji += "		<input type='hidden' class='angka form-control form-control-input text-center' name='id_evaluasi_biaya_gaji[]' value='"+b.id_evaluasi_biaya+"'/>";
							output_gaji += "		<input type='hidden' class='angka form-control form-control-input text-center' name='biaya_kgb_pembukaan[]' value='"+b.biaya_kgb_pembukaan+"'/>";
							output_gaji += "	</td>";
							output_gaji += "	<td>";
							output_gaji += "		<input type='text' class='angka form-control form-control-input text-center' name='biaya_gaji_kgb[]' value='"+numberWithCommas(parseFloat(biaya_kgb).toFixed(0))+"' placeholder='Biaya'/>";
							output_gaji += "		<input type='hidden' class='angka form-control form-control-input text-center' name='drc_rata_rata[]' value='"+parseFloat(drc_rata_rata)+"' placeholder='Biaya'/>";
							output_gaji += "		<input type='hidden' class='angka form-control form-control-input text-center' name='total_aktual_kering[]' value='"+parseFloat(total_aktual_kering)+"' placeholder='Biaya'/>";
							output_gaji += "	</td>";
							output_gaji += "	<td>";
							output_gaji += "		<input type='text' class='angka form-control text-center' name='biaya_gaji_kgk[]' value='"+numberWithCommas(parseFloat(biaya_kgb/total_aktual_kering).toFixed(0))+"' placeholder='Biaya'/>";
							output_gaji += "	</td>";
							output_gaji += "</tr>";
						}
					});
        ...
        complete: function () {
			...
			$('.form-control-input').prop('readonly', false);
	...
	//on change
    $(document).on("change", "input[name*='total_biaya_operasional_depo']", function() {
        if ($(this).val().replace(/,/g, "") < 0)
			$(this).val('');

        let row 						 = $(this).closest(".row-asumsi_depo");
        let sicom_depo					 = row.find("input[name*='sicom_depo']").val().replace(/,/g, "");
        let harga_beli_depo_depo		 = row.find("input[name*='harga_beli_depo_depo']").val().replace(/,/g, "");
        let harga_beli_depo_efek_batch	 = row.find("input[name*='harga_beli_depo_efek_batch']").val().replace(/,/g, "");
        let biaya_pabrik_depo			 = row.find("input[name*='biaya_pabrik_depo']").val().replace(/,/g, "");
		let total_biaya_operasional_depo = $(this).val().replace(/,/g, "");
		let net_margin_depo_depo		 = parseFloat(sicom_depo)-parseFloat(harga_beli_depo_depo)-parseFloat(biaya_pabrik_depo)-parseFloat(total_biaya_operasional_depo); 
		let net_margin_depo_efek_batch	 = parseFloat(sicom_depo)-parseFloat(harga_beli_depo_efek_batch)-parseFloat(biaya_pabrik_depo)-parseFloat(total_biaya_operasional_depo); 
        
        row.find("input[name*='net_margin_depo_depo']").val(numberWithCommas(parseFloat(net_margin_depo_depo).toFixed(0)));
        row.find("input[name*='net_margin_depo_efek_batch']").val(numberWithCommas(parseFloat(net_margin_depo_efek_batch).toFixed(0)));
		
		generate_total_net_margin_depo_efek_batch();
    });
    $(document).on("change", "input[name*='total_biaya_operasional_pabrik']", function() {
        if ($(this).val().replace(/,/g, "") < 0)
			$(this).val('');

        let row 						   = $(this).closest(".row-asumsi_pabrik");
        let harga_notarin_pabrik		   = row.find("input[name*='harga_notarin_pabrik']").val().replace(/,/g, "");
        let harga_beli_depo_pabrik		   = row.find("input[name*='harga_beli_depo_pabrik']").val().replace(/,/g, "");
		let total_biaya_operasional_pabrik = $(this).val().replace(/,/g, "");
		let margin_depo_pabrik			   = parseFloat(harga_notarin_pabrik)-parseFloat(harga_beli_depo_pabrik)-parseFloat(total_biaya_operasional_pabrik); 
        
        row.find("input[name*='margin_depo_pabrik']").val(numberWithCommas(parseFloat(margin_depo_pabrik).toFixed(0)));
		
		generate_total_margin_depo_pabrik();
    });
	
	//onkey up
    $(document).on("keyup", "input[name*='biaya_profesional_kgb']", function() {
        if ($(this).val().replace(/,/g, "") < 0)
			$(this).val('');

        let row 					= $(this).closest(".row-biaya_profesional");
        let biaya_profesional_kgb 	= $(this).val().replace(/,/g, "");
        let drc_rata_rata			= row.find("input[name*='drc_rata_rata']").val().replace(/,/g, "");
        let biaya_profesional_kgk 	= parseFloat(biaya_profesional_kgb) / parseFloat(drc_rata_rata);
        row.find("input[name*='biaya_profesional_kgk']").val(numberWithCommas(parseFloat(biaya_profesional_kgk).toFixed(0)));
		
		generate_total_biaya_profesional_kgb();
		generate_total_biaya_profesional_kgk();
		
		generate_total_biaya_operasional();
		
		
    });
    $(document).on("keyup", "input[name*='biaya_opex_kgb']", function() {
        if ($(this).val().replace(/,/g, "") < 0)
			$(this).val('');

        let row 			= $(this).closest(".row-biaya_opex");
        let biaya_opex_kgb 	= $(this).val().replace(/,/g, "");
        let drc_rata_rata	= row.find("input[name*='drc_rata_rata']").val().replace(/,/g, "");
        let biaya_opex_kgk 	= parseFloat(biaya_opex_kgb) / parseFloat(drc_rata_rata);
        row.find("input[name*='biaya_opex_kgk']").val(numberWithCommas(parseFloat(biaya_opex_kgk).toFixed(0)));
		
		generate_total_biaya_operasional();
		
    });
    $(document).on("keyup", "input[name*='biaya_angkut_kgb']", function() {
        if ($(this).val().replace(/,/g, "") < 0)
			$(this).val('');

        let row 			 = $(this).closest(".row-biaya_angkut");
        let biaya_angkut_kgb = $(this).val().replace(/,/g, "");
        let drc_rata_rata	 = row.find("input[name*='drc_rata_rata']").val().replace(/,/g, "");
        let biaya_angkut_kgk = parseFloat(biaya_angkut_kgb) / parseFloat(drc_rata_rata);
        row.find("input[name*='biaya_angkut_kgk']").val(numberWithCommas(parseFloat(biaya_angkut_kgk).toFixed(0)));
		
		generate_total_biaya_operasional();
    });
    $(document).on("keyup", "input[name*='biaya_gaji_kgb']", function() {
        if ($(this).val().replace(/,/g, "") < 0)
			$(this).val('');

        let row 			= $(this).closest(".row-biaya_gaji");
        let biaya_gaji_kgb 	= $(this).val().replace(/,/g, "");
        // let drc_rata_rata	= row.find("input[name*='drc_rata_rata']").val().replace(/,/g, "");
        let total_aktual_kering	= row.find("input[name*='total_aktual_kering']").val().replace(/,/g, "");
        let biaya_gaji_kgk 	= parseFloat(biaya_gaji_kgb) / parseFloat(total_aktual_kering);
        row.find("input[name*='biaya_gaji_kgk']").val(numberWithCommas(parseFloat(biaya_gaji_kgk).toFixed(0)));
		
		generate_total_biaya_gaji_kgb();
		generate_total_biaya_gaji_kgk();
	...
	$(document).on("click", "button[name='action_btn']", function(e){
		var empty_form = validate("#form_evaluasi_depo_edit");
		if(empty_form == 0){
	    	var isproses 		= $("input[name='isproses']").val();
	    	if(isproses == 0){
	    		$("input[name='isproses']").val(1);
		    	var formData = new FormData($("#form_evaluasi_depo_edit")[0]);

				$.ajax({
					url: baseURL+'depo/evaluasi/save/evaluasi',
					type: 'POST',
					dataType: 'JSON',
					data: formData,
					contentType: false,
					...
					// success: function(data){
                        // if (data.sts == 'OK') {
                            // swal('Success', data.msg, 'success').then(function () {
                                // location.reload(window.location = baseURL + 'depo/evaluasi/approve');
                            // });
                        // } else {
                            // $("input[name='isproses']").val(0);
                            // swal('Error', data.msg, 'error');
					...
					success: function (response) {
						...
						if (response) {
							...
							if (response.sts == "OK") {
								icon = "success";
								reload = baseURL + "depo/evaluasi/approve";
							}
...
function generate_modal_action(elem) {
    ...
    output += '             <input type="text" name="id_depo_master">';
    output += '         </div>';
    output += '     </form>';
    output += ' </div>';
    output += '</div>';
...
function generate_total_net_margin_depo_efek_batch() {
	let total = 0;
    $("#form_evaluasi_depo_edit input[name^='net_margin_depo_efek_batch']").each(function(i) {
        total += +$(this).val().replace(/,/g, "");
    });
    total = total.toFixed(2);
	$("input[name='total_net_margin_depo_efek_batch']").val(numberWithCommas(parseFloat(total).toFixed(0)));	
}

function generate_total_margin_depo_pabrik() {
	let total = 0;
    $("#form_evaluasi_depo_edit input[name^='margin_depo_pabrik']").each(function(i) {
        total += +$(this).val().replace(/,/g, "");
    });
    total = total.toFixed(2);
	$("input[name='total_margin_depo_pabrik']").val(numberWithCommas(parseFloat(total).toFixed(0)));	
}

function generate_total_biaya_profesional_kgb() {
	let total = 0;
    $("#form_evaluasi_depo_edit input[name^='biaya_profesional_kgb']").each(function(i) {
        total += +$(this).val().replace(/,/g, "");
    });
    total = total.toFixed(2);
	$("input[name='total_biaya_profesional_kgb']").val(numberWithCommas(parseFloat(total).toFixed(0)));	
}

function generate_total_biaya_profesional_kgk() {
	let total = 0;
    $("#form_evaluasi_depo_edit input[name^='biaya_profesional_kgk']").each(function(i) {
        total += +$(this).val().replace(/,/g, "");
    });
    total = total.toFixed(2);
	$("input[name='total_biaya_profesional_kgk']").val(numberWithCommas(parseFloat(total).toFixed(0)));	
}
function generate_total_biaya_gaji_kgb() {
	let total = 0;
    $("#form_evaluasi_depo_edit input[name^='biaya_gaji_kgb']").each(function(i) {
        total += +$(this).val().replace(/,/g, "");
    });
    total = total.toFixed(2);
	$("input[name='total_biaya_gaji_kgb']").val(numberWithCommas(parseFloat(total).toFixed(0)));	
}

function generate_total_biaya_gaji_kgk() {
	let total = 0;
    $("#form_evaluasi_depo_edit input[name^='biaya_gaji_kgk']").each(function(i) {
        total += +$(this).val().replace(/,/g, "");
    });
    total = total.toFixed(2);
	$("input[name='total_biaya_gaji_kgk']").val(numberWithCommas(parseFloat(total).toFixed(0)));	
}
function generate_total_biaya_operasional() {
	let total_biaya_profesional_kgk = $("input[name='total_biaya_profesional_kgk']").val().replace(/,/g, "");
	let biaya_opex_kgk 				= $("input[name='biaya_opex_kgk[]']").val().replace(/,/g, "");
	let biaya_angkut_kgk 			= $("input[name='biaya_angkut_kgk[]']").val().replace(/,/g, "");
	let total_biaya_gaji_kgk 		= $("input[name='total_biaya_gaji_kgk']").val().replace(/,/g, "");
	let total_biaya_asuransi_kgk 	= $("input[name='total_biaya_asuransi_kgk']").val().replace(/,/g, "");
	let total_biaya_operasional 	= parseFloat(total_biaya_profesional_kgk)+parseFloat(biaya_opex_kgk)+parseFloat(biaya_angkut_kgk)+parseFloat(total_biaya_gaji_kgk)+parseFloat(total_biaya_asuransi_kgk);
	$("input[name='total_biaya_operasional']").val(numberWithCommas(parseFloat(total_biaya_operasional).toFixed(0)));
	$("input[name='total_biaya_operasional_depo[]']").val(numberWithCommas(parseFloat(total_biaya_operasional).toFixed(0))).trigger('change');
	$("input[name='total_biaya_operasional_pabrik[]']").val(numberWithCommas(parseFloat(total_biaya_operasional).toFixed(0))).trigger('change');
