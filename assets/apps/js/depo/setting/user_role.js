$(document).ready(function(){
	...
	$(document).on("click", ".nonactive, .setactive", function (e) {
		$.ajax({
			url: baseURL + "depo/setting/set/user",
			type: 'POST',
			dataType: 'JSON',
			data: {
	...
	$(".edit").on("click", function(e){
		...
		$.ajax({
    		url: baseURL+'depo/setting/get/user_role',
			type: 'POST',
			dataType: 'JSON',
			data: {
	...
	$(document).on("click", "button[name='action_btn']", function(e){
		...
		if(empty_form == 0){
	    	...
	    	if(isproses == 0){
		    	...
		    	var formData = new FormData($(".form-master_depo-user_role")[0]);

				$.ajax({
					url: baseURL+'depo/setting/save/user',
					type: 'POST',
					dataType: 'JSON',
					data: formData,
					contentType: false,
	...
	// $("#user").select2({
        ...
        ajax: {
            ...
            // url: baseURL+'depo/setting/get_user_auto',
            // url: baseURL+'depo/setting/get_posisi_auto',
            url: baseURL+'depo/setting/get/user',
            dataType: 'json',
            delay: 250,
