...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.header) {
                ...
                $.each(data.header, function(i,header){
                    ...
                    $("input[name='tgl_pengajuan']").val(header.tanggal_pengajuan);
                ...
                $.each(data.analisa_harga, function(i,v){
                    ...
                    if(counter_tabel !== v.no_tabel){
                        ...
                        //if calon pemenang < dari default
                    ...
                    // insert data edit
                    $("input[name='nb_tabel"+v.no_tabel+"_row"+row+"']").val(v.nbv);
                    ...
                    $("input[name='harga_terakhir_tabel"+v.no_tabel+"_row"+row+"']").val(parseInt(v.harga_terakhir));
                    $("input[name='harga_varian_tabel"+v.no_tabel+"_row"+row+"']").val(v.harga_varian);
                    $("input[name='total_varian_tabel"+v.no_tabel+"_row"+row+"']").val(v.total_varian);
                    $("input[name='harga_nego_tabel"+v.no_tabel+"_row"+row+"']").val(v.harga_nego);
                    $("input[name='total_harga_nego_tabel"+v.no_tabel+"_row"+row+"']").val(v.total_harga_nego);
                    ...
                    if (v.kode_asset){
                        $("input[name='kode_aset_tabel"+v.no_tabel+"_row"+row+"']").val(v.kode_asset);
                        $("input[name='sno_tabel"+v.no_tabel+"_row"+row+"']").val(v.sno);
                        $("input[name='cap_date_tabel"+v.no_tabel+"_row"+row+"']").val(v.cap_date);
                    ...
                    $("select[name='kode_material_tabel"+v.no_tabel+"_row"+row+"']").append(new Option(v.full_description, v.kode_material, true, true)).trigger("change.select2");
                ...
                $.each(data.calon_pembeli, function(i,v){
                    ...
                    $("input[name='harga_satuan_tabel"+v.no_tabel+"_row"+v.no_row+"_calon"+v.no_urut+"']").val(parseFloat(v.harga_satuan))
                    ...
                    total_sementara = total_sementara || 0;
        ...
        complete: function () {
            ...
            $(".form-scoring-scrap input, .form-scoring-scrap select, .form-scoring-scrap textarea").attr('disabled','disabled');
	...
	// 		case 'png' :
	// 		case 'jpg' :
	// 			output += '<img class="img-responsive" style="margin: 0 auto;" alt="Photo" src="' + link + '">';
	// 			break;
	// 	}
    ...
    //     $("input[name='nama_"+name+"']").attr("required", true);
    ...
    $(".select-material").on("select2:unselect", function(e) {
        ...
        $(this).closest("tr").find('.acc').val('');
        $(this).closest("tr").find('.acc').html('');
    ...
    $(document).on("click", ".add-col-pembeli", function (e) {
        ...
        for (let i = 1; i < (row+1); i++) {
            ...
            output_harga_calon          += "<input type='hidden' name='id_calon_pembeli_tabel"+indexTabel+"_row"+i+"_calon"+(count +1)+"'>";
            output_harga_calon          += "</div>";
            output_harga_calon          += "</td>";
            output_harga_calon          += "<td class='text-center mw200'>";
            output_harga_calon          += "<div class='input-group'>";
            output_harga_calon          += "<div class='input-group-addon'>Rp</div>";
            output_harga_calon          += "<input type='text' name='harga_total_tabel"+indexTabel+"_row"+i+"_calon"+(count +1)+"' data-calon='"+(count +1)+"' class='text-right form-control col-sm-12 angka total-harga-satuan calon_harga_tabel"+indexTabel+"_row"+i+"' value='0' readonly required='required'>";
            output_harga_calon          += "</div>";
            output_harga_calon          += "</td>";
        ...
        output_nama_customer     += "<input name='nama_customer_tabel"+indexTabel+"_calon"+(count +1)+"' class='form-control' required placeholder='Nama Pembeli'>";
        ...
        output_th          += "<th class='text-center'>Harga Satuan<br><small><em>Sebelum PPN</em></small></th>";
        output_th          += "<th class='text-center th-calon_tabel"+indexTabel+"'>Total<br><small><em>Sebelum PPN</em></small></th>";
	...
	$(document).on("click", ".add-row", function (e) {
        ...
        for (let i = 1; i < (calon+1); i++) {
            ...
            output_harga_calon          += "<div class='input-group'>";
            output_harga_calon          += "<div class='input-group-addon'>Rp</div>";
            output_harga_calon          += "<input type='text' name='harga_total_tabel"+indexTabel+"_row"+row+"_calon"+i+"' data-calon='"+i+"' class='text-right form-control col-sm-12 angka total-harga-satuan calon_harga_tabel"+indexTabel+"_row"+row+"' value='0' readonly required='required'>";
            output_harga_calon          += "</div>";
            output_harga_calon          += "</td>";
		...
		output          += "    <td class='mw200'><select name='kode_material_tabel"+indexTabel+"_row"+row+"' class='form-control select-material select_material_tabel"+indexTabel+"_row"+row+" autocomplete' required data-allowclear='true'>";
		output          += "    <input type='hidden' name='id_row_analisa_tabel"+indexTabel+"_row"+row+"'></td>";
        ...
        output          += "            <input type='text' name='kode_asset_tabel"+indexTabel+"_row"+row+"' class='text-right form-control acc input-acc angka mw150' readonly>";
        output          += "            <div class='input-group-addon'>-</div>";
        output          += "            <input type='text' name='sno_tabel"+indexTabel+"_row"+row+"' class='text-right form-control angka acc input-acc mw40' readonly>";
        output          += "        </div>";
        output          += "    </td>";
        output          += "    <td class='text-center mw200'>";
        output          += "        <textarea name='deskripsi_asset_tabel"+indexTabel+"_row"+row+"' class='form-control col-sm-12 acc' readonly ></textarea>";
        output          += "    </td>";
		output          += "    <td class='text-center mw150'><input type='text' class='form-control col-sm-12 acc' name='cap_date_tabel"+indexTabel+"_row"+row+"' readonly></td>";
        output          += "    <td class='text-center mw200'>";
        output          += "        <div class='input-group'>";
        output          += "            <div class='input-group-addon'>Rp</div>";
        output          += "            <input type='text' class='text-center form-control col-sm-12 angka acc' readonly name='nbv_tabel"+indexTabel+"_row"+row+"'>";
        output          += "        </div>";
        output          += "    </td>";
	...
	$(document).on("click", ".add-ann", function (e) {
        ...
        for (let i = 1; i < (2+1); i++) {
            ...
            output_harga_calon          += "<input type='hidden' name='id_calon_pembeli_tabel"+indexTabel+"_row1_calon"+i+"'>";
            output_harga_calon          += "</div>";
            output_harga_calon          += "</td>";
            output_harga_calon          += "<td class='text-center mw200'>";
            output_harga_calon          += "<div class='input-group'>";
		...
		output          += "    <td class='text-center mw200'>";
        output          += "        <div class='input-group'>";
        output          += "            <input type='text' class='form-control mw150 input-acc acc' name='kode_asset_tabel"+indexTabel+"_row"+row+"' readonly>";
        output          += "            <div class='input-group-addon'>-</div>";
        output          += "            <input type='text' class='form-control mw40 input-acc acc' name='sno_tabel"+indexTabel+"_row"+row+"' readonly>";
        output          += "        </div>";
        output          += "    </td>";
        output          += "    <td class='text-center mw200'>";
        output          += "        <textarea name='deskripsi_asset_fincon_tabel"+indexTabel+"_row"+row+"' class='form-control col-sm-12 acc' readonly></textarea>";
        output          += "    </td>";
		output          += "    <td class='text-center mw150'><input type='text' class='form-control col-sm-12 acc' name='cap_date_tabel"+indexTabel+"_row"+row+"' readonly></td>";
        output          += "    <td class='text-center mw200'>";
        output          += "        <div class='input-group'>";
        output          += "            <div class='input-group-addon'>Rp</div>";
        output          += "            <input type='text' class='text-center form-control col-sm-12 acc' readonly name='nbv_tabel"+indexTabel+"_row"+row+"'>";
        output          += "        </div>";
        output          += "    </td>";
        ...
        output          += "        <div class='input-group'>";
        output          += "            <div class='input-group-addon'>Rp</div>";
        output          += "            <input type='text' name='harga_nego_tabel"+indexTabel+"_row"+row+"' value='0' readonly class='text-right form-control col-sm-12 angka' >";
        output          += "        </div>";
        output          += "    </td>";
        output          += "    <td class='text-center mw200'>";
        output          += "        <div class='input-group'>";
        output          += "            <div class='input-group-addon'>Rp</div>";
        output          += "            <input type='text' name='total_harga_nego_tabel"+indexTabel+"_row"+row+"' value='0' readonly class='text-right form-control col-sm-12 angka' >";
        output          += "        </div>";
		output          += "    </td>";
        ...
        output          += "        <div class='input-group'>";
        output          += "            <div class='input-group-addon'>Rp</div>";
        output          += "            <input type='text' name='harga_varian_tabel"+indexTabel+"_row"+row+"' readonly value='0' class='text-right form-control col-sm-12 angka' >";
        output          += "        </div>";
        output          += "    </td>"; 
        output          += "    <td class='text-center mw200'>";
        output          += "        <div class='input-group'>";
        output          += "            <div class='input-group-addon'>Rp</div>";
        output          += "            <input type='text' name='total_varian_tabel"+indexTabel+"_row"+row+"' readonly value='0' class='text-right form-control col-sm-12 angka' >";
        output          += "        </div>";
        output          += "    </td>";
