			...
			success: function (data) {
				if(data) {	
					...
					$.each(data, function(i,j){
						...
						var link_deviasi = baseURL + "kiass/deviasi/tambah/" + j.no_pp.replace(/\//g, "-");
						...
						if( $("input[name='session_role_level']").val() == '1' && j.status == 'finish' && j.cek_so == '0' && j.count_deviasi == '0'){
							output += "		<li><a href='" + link_deviasi + "' class='action' target='" + target_link + "'><i class='fa fa-plus'></i> Buat Deviasi</a></li>";			
						}
