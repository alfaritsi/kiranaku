			...
			<div class="col-sm-4">
				<div class="box box-success">
		          	<div class="box-header with-border">
		              	<h3 class="box-title title-form">Form List Berita Duka</h3>
		              	<button type="button" class="btn btn-sm btn-default pull-right hidden" id="btn-new">Add Berita Duka</button>
		          	</div>
		          	<form role="form" class="form-master-berita">
	            		<div class="box-body">
							<div class="form-group">
		              		...
		              		<div class="form-group">
		                		<label for="editorial1">Editorial (Baris 1)</label>
								<textarea class="form-control" name="editorial1" id="editorial1" placeholder="Masukan Editorial (Baris 1)" required="required"></textarea>
		                	</div>
		              		<div class="form-group">
		                		<label for="editorial2">Editorial (Baris 2)</label>
								<textarea class="form-control" name="editorial2" id="editorial2" placeholder="Masukan Editorial (Baris 2)" required="required"></textarea>
		                	</div>
		              		<div class="form-group">
		                		<label for="editorial3">Editorial (Baris 3)</label>
								<textarea class="form-control" name="editorial3" id="editorial3" placeholder="Masukan Editorial (Baris 3)" required="required"></textarea>
		                	</div>
		              		<div class="form-group">
		                		<label for="editorial4">Editorial (Footer)</label>
								<textarea class="form-control" name="editorial4" id="editorial4" placeholder="Masukan Editorial (Footer)" required="required"></textarea>
		                	</div>
		              		<div class="form-group">
		                		<label for="nama_keluarga">Nama Keluarga Yang Bersangkutan</label>
		                		<input type="text" class="form-control" name="nama_keluarga" id="nama_keluarga" placeholder="Input Nama Keluarga" required="required">
		                	</div>
		              		<div class="form-group">
		                		<label for="status_keluarga">Status Keluarga Yang Bersangkutan</label>
		                		<input type="text" class="form-control" name="status_keluarga" id="status_keluarga" placeholder="Input Status Keluarga" required="required">
		                	</div>
							<div class="form-group">
							...
							<!--
		              		<div class="form-group">
		                		...
		                		<select class="form-control select2 col-sm-12" multiple="multiple" name="email[]" id="email" data-placeholder="Pilih Email" required="required">
		                			<?php
		                				foreach($email as $dt){
		                					echo "<option value='".$dt->email."'>".$dt->email."</option>";
		                				}
		                			?>
		                		</select>
		              		</div>
...
<script src="<?php echo base_url() ?>assets/apps/js/berita/master/duka.js"></script>
<!--export to excel-->
