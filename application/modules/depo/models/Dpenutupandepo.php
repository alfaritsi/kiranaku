...
class Dpenutupandepo extends CI_Model
{
	...
	function get_data_penutupan_sdm($conn = NULL, $nomor = NULL) {
		...
		$this->db->select("CONVERT(varchar, tbl_depo_penutupan_sdm.tanggal_aktual, 104) as tanggal_aktual_format");
	...
	function get_data_penutupan_asset($conn = NULL, $nomor = NULL) {
		...
		$this->db->select("CONVERT(varchar, tbl_depo_penutupan_asset.tanggal_aktual, 104) as tanggal_aktual_format");
	...
	function get_data_penutupan_keuangan($conn = NULL, $nomor = NULL) {
		...
		$this->db->select("CONVERT(varchar, tbl_depo_penutupan_keuangan.tanggal_aktual, 104) as tanggal_aktual_format");
	...
	function get_data_penutupan_bokar($conn = NULL, $nomor = NULL) {
		...
		$this->db->select("CONVERT(varchar, tbl_depo_penutupan_bokar.tanggal_aktual, 104) as tanggal_aktual_format");
	...
	function get_data_penutupan_lain($conn = NULL, $nomor = NULL) {
		...
		$this->db->select("CONVERT(varchar, tbl_depo_penutupan_lain.tanggal_aktual, 104) as tanggal_aktual_format");
	...
	function get_email_recipient($param = NULL)
    {
        ...
        $query = $this->db->query("EXEC SP_Kiranaku_Penutupan_Depo_Recipient_Email '" . $param['nomor'] . "'");
        $result = $query->result();
	...
	function get_data_history($conn = NULL, $nomor = NULL, $active = NULL, $deleted = 'n')
	{
		...
		$this->db->where("tbl_depo_penutupan_log.realisasi='n'");
		$query  = $this->db->get();
		$result = $query->result();
	...
	function get_penutupan_depo_bom($conn = NULL, $nomor = NULL, $active = NULL, $deleted = 'n', $pabrik_filter = NULL, $status_filter = NULL, $view_data = NULL)
	{
		if ($conn !== NULL)
			$this->general->connectDbPortal();
		...
		$this->datatables->select(" 
									...
									na,
									del");
		$this->datatables->from('vw_depo_penutupan');
