		...
		<div class="row">
			<div class="col-sm-12">
				<div class="nav-tabs-custom" id="tabs-edit">
					<form role="form" id="form_evaluasi_depo" enctype="multipart/form-data">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Detail Evaluasi Kinerja Depo</h4>
						</div>
										...
										<div class="col-sm-12">
											<div class="table-responsive">
												<table class="table table-hover table-bordered">
													<thead>
														<tr>
															<th class="text-left" colspan="3">A. Biaya Operasional</th>
														</tr>
													</thead>
													<tbody>
														<tr>
															<td colspan="3">
																...
																<div class="table-responsive">
																	<table class="table table-hover table-bordered table-biaya_profesional">
																		...
																		<tfoot>
																			<th>&nbsp;</th>
																			<th><input type="text" class='form-control text-center' name='total_biaya_profesional_kgb' required='required' readonly /></th>
																			<th><input type="text" class='form-control text-center' name='total_biaya_profesional_kgk' required='required' readonly /></th>
																		</tfoot>
																	</table>
																</div>
																<!--sub tabel-->
																...
																<div class="table-responsive">
																	<table class="table table-hover table-bordered  table-biaya_gaji">
																		...
																		<tfoot>
																			<th>&nbsp;</th>
																			<th><input type="text" class='form-control text-center' name='total_biaya_gaji_kgb' required='required' readonly /></th>
																			<th><input type="text" class='form-control text-center' name='total_biaya_gaji_kgk' required='required' readonly /></th>
																		</tfoot>
...
<script src="<?php echo base_url() ?>assets/apps/js/depo/evaluasi/detail.js"></script>
