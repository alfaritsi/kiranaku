										...
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													...
													<input style="text-transform: uppercase" type="text" class="form-control form-control-hide" name="nip" id="nip" value="" placeholder="NIP" maxlength="15" required="required">
												</div>
												<div class="col-xs-6">
													<label for="npwp">NPWP</label>
													<input style="text-transform: uppercase" type="text" class="form-control form-control-hide" name="npwp" id="npwp" value="" placeholder="NPWP" maxlength="16"  required="required">
												</div>
											</div>
										</div>
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													...
													<input type="text" class="form-control form-control-hide" name="kabupaten" id="kabupaten" value="" placeholder="Kabupaten"  required="required">
												</div>
												<div class="col-xs-6">
													<label for="propinsi">Provinsi</label>
													<input type="text" class="form-control form-control-hide" name="propinsi" id="propinsi" value="" placeholder="Provinsi"  required="required">
												</div>
											</div>
										</div>
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													...
													<textarea name="alamat_rumah" id="alamat_rumah" class="form-control form-control-hide" rows="3" placeholder="Masukan Alamat Rumah" required="required"></textarea>
												</div>
												<div class="col-xs-6">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-xs-6">
													...
													<input style="text-transform: uppercase" type="text" class="form-control form-control-hide" name="pekerjaan" id="pekerjaan" value="" placeholder="Pekerjaan"  required="required">
												</div>
											</div>
										</div>
										<div class="form-group">
								...
								<div class="tab-pane" id="tab-aktifitas">
									...
									<fieldset class="fieldset-default">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-xs-6">
													<label for="volume_bokar_mitra_per_hari">Volume Bokar Mitra Per Hari</label>
									...
									<fieldset class="fieldset-default">
										...
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													<label for="frekuensi_penjualan_rekan_mitra_per_minggu">Frekuensi Penjualan Rekan Mitra Per Minggu</label>
													<input type="text" class="form-control angka" name="frekuensi_penjualan_rekan_mitra_per_minggu" id="Frekuensi Penjualan Rekan Mitra Per Minggu" placeholder="Frekuensi Penjualan Rekan Mitra Per Minggu" required="required">
												</div>
												<div class="col-xs-6">
													<label for="volume_bokar_mitra_per_hari">Volume Bokar Rekan Mitra Per Hari</label>
													<input type="text" class="form-control angka" name="volume_bokar_rekan_mitra_per_hari" id="volume_bokar_rekan_mitra_per_hari" placeholder="Volume Bokar Rekan Mitra Per Hari" required="required">
												</div>
											</div>
										</div>
									</fieldset>								
									<fieldset class="fieldset-default">
										...
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													<label for="status_sosial_mitra">Status Sosial Mitra</label>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													...
													<input type="text" class="form-control angka" name="jumlah_pelelangan" id="jumlah_pelelangan" placeholder="Jumlah Pelelangan" required="required">
												</div>
												<div class="col-xs-6">
...
<script src="<?php echo base_url() ?>assets/apps/js/depo/evaluasi/input.js"></script>
