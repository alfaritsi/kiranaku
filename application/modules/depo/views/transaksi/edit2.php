				...
				<div class="nav-tabs-custom" id="tabs-edit">
					<form role="form" class="form-depo-input" enctype="multipart/form-data">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Edit Master Depo</h4>
						</div>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														...
														<tbody>
															<tr>
																<td><input type='text' class='angka form-control text-center' name='target_m1' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m2' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m3' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m4' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m5' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m6' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m7' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m8' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m9' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m10' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m11' required='required' /></td>
																<td><input type='text' class='angka form-control text-center' name='target_m12' required='required' /></td>
															</tr>
														</tbody>
													</table>
												</div>
...
<script src="<?php echo base_url() ?>assets/apps/js/depo/transaksi/edit.js"></script>
