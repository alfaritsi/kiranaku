										...
										<div class="form-group">
											<div class="row">
												<div class="col-xs-6">
													...
													<div class="input-group">
														<input type="text" class="form-control angka" name="frekuensi_penjualan_rekan_mitra_per_minggu" id="frekuensi_penjualan_rekan_mitra_per_minggu" placeholder="frekuensi_penjualan_rekan_mitra_per_minggu">
														<span class="input-group-addon">Hari</span>
													</div>												
												</div>
												<div class="col-xs-6">
													...
													<div class="input-group">
														<input type="text" class="form-control angka" name="volume_bokar_rekan_mitra_per_hari" id="volume_bokar_rekan_mitra_per_hari" placeholder="volume_bokar_rekan_mitra_per_hari">
														<span class="input-group-addon">Ton Krg</span>
													</div>												
												</div>
											</div>
