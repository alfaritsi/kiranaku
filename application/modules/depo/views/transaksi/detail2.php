													...
													<table class="table table-hover table-bordered">
														<thead>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																<th class="text-left" colspan="6">POTENSI (75%)</th>
															</tr>
															<tr>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														<thead>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																<th class="text-left" colspan="6">MITRA (15%)</th>
															</tr>
															<tr>
																<th class="text-center">Jenis Penilaian</th>
																<th class="text-center" width="15%">Bobot</th>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														<thead>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																<th class="text-left" colspan="6">ANALISIS PROFITABILITAS (10%)</th>
															</tr>
															<tr>
															<tr>
																<th class="text-center">Jenis Penilaian</th>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														<thead>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																<th class="text-left" colspan="3">POTENSI (75%)</th>
															</tr>
															<tr>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														<thead>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																<th class="text-left" colspan="3">MITRA (15%)</th>
															</tr>
															<tr>
																<th class="text-center">Aktivitas Usaha Mitra</th>
																<th class="text-center" width="25%">Keterangan</th>
																<th class="text-center" width="15%">Total Presentase</th>
															</tr>
														</thead>
														<tbody>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														<thead>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																<th class="text-left" colspan="3">ANALISIS PROFITABILITAS (10%)</th>
															</tr>
															<tr>
																<th class="text-center">Purchase margin</th>
																<th class="text-center" width="25%">Total</th>
																<th class="text-center" width="15%">Presentase</th>
															</tr>
														</thead>
														<tbody>
															<tr id="nodata_scoring_profit">
																<td colspan="3">No data found</td>
															</tr>
														</tbody>
													</table>
											...
											<div class="col-sm-4">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														...
														<tbody>
															<tr><td>Kadar</td><td>%</td><td>999</td></tr>
															<tr><td>Qty. Beli /bln</td><td>MT</td><td>999</td></tr>
															<tr><td>Harga Beli</td><td>Rp/kgb</td><td>999</td></tr>
														...
														<tbody>
															<tr>
																<td colspan="3">
																	<!--sub tabel-->
																	<div class="table-responsive">
																		<table class="table table-hover table-bordered table-analisis_biaya_tetap">
																			<thead>
																				<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																	...
																	<!--sub tabel-->
																	<div class="table-responsive">
																		<table class="table table-hover table-bordered table-analisis_biaya_mitra">
																			<thead>
																				<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																	...
																	<!--sub tabel-->
																	<div class="table-responsive">
																		<table class="table table-hover table-bordered table-analisis_biaya_sdm">
																			<thead>
																				<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																					<th class="text-left" colspan="3">3. Biaya Terkait Karyawan</th>
																				</tr>
																				<tr>
																					<th class="text-center" width="10%">No</th>
																					<th class="text-center">Jenis Biaya</th>
																	...
																	<!--sub tabel-->
																	<div class="table-responsive">
																		<table class="table table-hover table-bordered table-analisis_biaya_premi">
																			<thead>
																				<tr style='background-color: rgba(0, 141, 76, 0.3);'>
																					<th class="text-left" colspan="3">4. Biaya Premi Asuransi</th>
																				</tr>
																				<tr>
																					<th class="text-center" width="10%">No</th>
																					<th class="text-center">Jenis Biaya</th>
												...
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														...
														<tbody>
															...
															<tr><td>Harga Beli Pabrik</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td>Total Cost Depo</td><td>999</td><td>Rp/kgk</td></tr>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'><td>Target Beli Depo</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td colspan="3">&nbsp;</td></tr>
															<tr><td>Target H. Beli Depo</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td>Survei Harga Beli Depo</td><td>999</td><td>Rp/kgk</td></tr>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'><td>Deviasi depo -pabrik</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td colspan="3">&nbsp;</td></tr>
															<tr><td>SICOM - (Kode Pabrik)</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td>Harga Beli Depo</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td>Budget Total Cost Factory</td><td>999</td><td>Rp/kgk</td></tr>
															<tr><td>Total Biaya Operasional</td><td>999</td><td>Rp/kgk</td></tr>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'><td>Nett Margin</td><td>999</td><td>Rp/kgk</td></tr>
														</tbody>
													</table>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-sm-8">
												<div class="table-responsive">
													<table class="table table-hover table-bordered">
														<tbody>
															<tr><td>Total Biaya Investasi</td><td width="10%">-</td><td width="10%">999</td></tr>
															<tr><td>Rerata Target Beli per bulan (Kg Krg)</td><td width="10%">999</td><td width="10%">-</td></tr>
															<tr><td>Proyeksi Nett Margin per bulan</td><td width="10%">999</td><td width="10%">-</td></tr>
															<tr><td>Total Profit (Bulan)</td><td width="10%">999</td><td width="10%">-</td></tr>
															<tr style='background-color: rgba(0, 141, 76, 0.3);'><td>Payback Period (Tahun)</td><td width="10%">-</td><td width="10%">999</td></tr>
														</tbody>
													</table>
												</div>
											</div>
