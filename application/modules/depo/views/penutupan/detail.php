		...
		<div class="row">
			<div class="col-sm-12">
				<div class="nav-tabs-custom" id="tabs-edit">
					<form role="form" id="form_penutupan_depo_detail" enctype="multipart/form-data">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Edit Penutupan Depo</h4>
						</div>
...
<script src="<?php echo base_url() ?>assets/apps/js/depo/penutupan/detail.js"></script>
