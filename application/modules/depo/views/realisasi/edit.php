		...
		<div class="row">
			<div class="col-sm-12">
				<div class="nav-tabs-custom" id="tabs-edit">
					<form role="form" id="form_realisasi_penutupan_depo_edit" enctype="multipart/form-data">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">Edit Realisasi Penutupan Depo</h4>
						</div>
										...
										<fieldset class="fieldset-default">
											...
											<table class="table table-hover table-bordered table-bokar">
												...
												<tbody>
													<tr>
														<td>
															<input type='hidden' name='bokar_nama' value='bokar'/>
														...
														<td>
															<input type='text' class='angka form-control input-control text-center' name='bokar_penyelesaian_aktual' placeholder="Jumlah Tonase Penyelesaian"/>
														</td>
														<td>
															<input type='text' class='form-control input-control tanggal' name='bokar_tanggal_aktual' placeholder="Jumlah Tonase (KGB)"/>
														</td>
													</tr>
												</tbody>
											</table>
...
<script src="<?php echo base_url() ?>assets/apps/js/depo/realisasi/edit.js"></script>
