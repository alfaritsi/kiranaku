			...
			<div class="col-sm-12">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">History Realisasi Penutupan Depo</h4>
					</div>
					<div class="modal-body">
						<div id='histori_penutupan'></div>
					</div>
...
<script src="<?php echo base_url() ?>assets/apps/js/depo/realisasi/approve.js"></script>
