				...
				<div class="box box-success page-wrapper"
					...
					<form class="form-scoring-um"
							...
							<div class="row">
								<div class="col-sm-6 form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="hidden" name="pabrik"/>
											<input type="hidden" name="plafon_pabrik" value="<?php echo $plafon_pabrik; ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<div class="input-group">
												...
												<div class="input-group-btn">
													<input type="text"
														   name="npwp_file_hidden"
														   class="form-control hidden data-lihat-file readonly">
													<button type="button"
															class="btn btn-default btn-flat lihat-file"
															data-title="File NPWP"
															title="klik untuk lihat file"><i class="fa fa-search"></i>
													</button>
												</div>
											</div>
									...
									<fieldset class="fieldset-success">
										...
										<div class="tab-content">
											...
											<div class="tab-pane hide3 hide4"
												...
												<div class="row">
													<div class="col-sm-12">
														<input type="hidden" name="std_scoring">
														<input type="hidden" name="nilai_scoring">
												...
												<div class="form-group hide1 hide2 hide3">
													...
													<div class="col-sm-8">
														<div class="input-group">
															...
															<div class="input-group-btn">
																<input type="file" name="ranger_file[]" class="form-control upload_file" style="display:none;">
																<button type="button" class="btn btn-default btn-flat btn_upload_file" data-title="Upload"><i class="fa fa-upload"></i></button>
															</div>
															<div class="input-group-btn">
																<button type="button" class="btn btn-default btn-flat view_file" data-col="8" data-link="" data-title="Lihat file"><i class="fa fa-search"></i></button>
															</div>
														</div>
													</div>
												</div>
						...
						<div class="box-footer">
							...
							<input type="hidden"
								   name="id_scoring"
								   value="<?php echo $generate->kirana_encrypt(str_replace("-", "/", $no_form)); ?>">
							<input type="hidden"
								   name="action">
							<button type="button"
...
<script src="<?php echo base_url() ?>assets/apps/js/umb/scoring/edit.js"></script>
