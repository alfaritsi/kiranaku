...
class Dusers extends CI_Model
{
    public $mainTable = "tbl_user";
    public $mainPK = "id_user";

    function get_all_data($id = NULL, $all = NULL)
    {
        $this->general->connectDbPortal();

        $this->db->select("tbl_user.id_user,tbl_user.na,tbl_user.username,tbl_karyawan.id_karyawan,tbl_karyawan.nik,tbl_karyawan.ho,tbl_karyawan.email,tbl_karyawan.nama,tbl_departemen.nama as nama_departemen");
        $this->db->from($this->mainTable);
        $this->db->join('tbl_karyawan',$this->mainTable.'.id_karyawan = tbl_karyawan.id_karyawan','left outer');
    ...
    public function GetFields($_tbl, $_key, $_value, $_results, $oneRow = false, $_group='', $_order='', $_limit= '') {
        $this->general->connectDbPortal();
