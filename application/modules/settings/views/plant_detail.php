<!--
/*
@application  : Mapping Plant Access
		          	...
		          	<div class="box-body">
						<table class="table table-bordered table-striped my-datatable-extends-order">
			              	...
			              	<tbody>
			              		<?php
								$no = 1;
				              	foreach($plant_detail as $dt){
				              		$no++;
									echo "<tr>";
				              		echo "<td>".$dt->apps."</td>";
				              		echo "<td>".$dt->plant."</td>";
									echo "<td>";
										if(!empty($dt->plant_access)){
											$plant_access = explode(",", $dt->plant_access);
											foreach ($plant_access as $l) {
			...
			<div class="col-sm-4">
				<div class="box box-success">
		          	<div class="box-header with-border">
		              	<h3 class="box-title title-form">Form Mapping Plant Detail</h3>
		          	...
		          	<form role="form" class="form-mapping-header">
	            		<div class="box-body">
							...
							<div class="form-group">
		                		...
		                		<select class="form-control select2 col-sm-12" name="plant" id="plant" data-placeholder="Chose Plant" required="required">
		                			<?php
										echo "<option value='0'>Chose Plant</option>";
		                				foreach($plant as $dt){
		              		...
		              		<div class="form-group">
		                		<label for="posisi">Plant Access</label>
		                		<select class="form-control select2 col-sm-12" multiple="multiple" name="plant_access[]" id="plant_access" data-placeholder="Chose Plant Access" required="required">
		                			<?php
		                				foreach($plant as $dt){
		                					echo "<option value='".$dt->plant."'>".$dt->plant."</option>";
		                				}
...
<script src="<?php echo base_url() ?>assets/apps/js/settings/mapping/plant_detail.js"></script>
<!--export to excel-->
