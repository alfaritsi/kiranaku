                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered my-datatable-extends-order">
                            ...
                            <tbody>
                            <?php
                            foreach ($fbkwanita as $dt) {
                                $enId = $this->generate->kirana_encrypt($dt->id_fbk_cek);
...
<script src="<?php echo base_url() ?>assets/apps/js/settings/fbkwanita/fbkwanita.js"></script>
