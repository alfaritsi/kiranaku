			...
			<div class="col-sm-4">
				<div class="box box-success">
		          	<div class="box-header with-border">
		              	<h3 class="box-title title-form">Form Master Jenis Dokumen</h3>
		              	<button type="button" class="btn btn-sm btn-default pull-right hidden" id="btn-new">Add Dokumen</button>
		          	</div>
		          	<!-- /.box-header -->
		          	<!-- form start -->
		          	<form role="form" class="form-master-jenis-dokumen">
...
<script src="<?php echo base_url() ?>assets/apps/js/settings/master/dokumen.js"></script>
<!--export to excel-->
