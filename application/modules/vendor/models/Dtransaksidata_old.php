...
class Dtransaksidata extends CI_Model
{
	...
	*/
	...
	function push_data_master_vendor_change($id_data_temp = null)
	{
		$string	= "
			select 
			tbl_vendor_data_temp.nama as NAME1,
			tbl_vendor_data_temp.alamat as STREET,
			tbl_vendor_data_temp.no as HOUSE_NUM1,
			tbl_vendor_data_temp.kode_pos as POST_CODE1,  
			tbl_vendor_data_temp.kota as CITY1, 
			tbl_vendor_data_temp.negara as COUNTRY,
			--tbl_vendor_data_temp.provinsi as REGION,
			CASE
				WHEN tbl_vendor_data_temp.provinsi = '0' THEN ''
				ELSE tbl_vendor_data_temp.provinsi
			END as REGION,          
			tbl_vendor_data_temp.npwp as STCD1,
			tbl_vendor_data_temp.ktp as STCD4,
			--tbl_vendor_data_temp.tax_type as WITHT,
			CASE
				WHEN tbl_vendor_data_temp.tax_type = '0' THEN ''
				ELSE tbl_vendor_data_temp.tax_type
			END as WITHT,          
			--tbl_vendor_data_temp.tax_code as WT_WITHCD
			CASE
				WHEN tbl_vendor_data_temp.tax_code = '0' THEN ''
				ELSE tbl_vendor_data_temp.tax_code
			END as WT_WITHCD          
			from  
	...
	function ck_data_plant($id_data = null)
	{
		$string	= "select count(*) from tbl_vendor_plant where id_data='$id_data' and status_sap='n' and status_delete='n'";
