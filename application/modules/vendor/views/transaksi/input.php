				...
				<div class="nav-tabs-custom" id="tabs-edit">
					<form role="form" class="form-transaksi-vendor" enctype="multipart/form-data">
						...
						<ul class="nav nav-tabs">
							...
							<li class="form-control_change"><a href="#tab-change_data" data-toggle="tab">Data Change</a></li>
							<li class="form-control_change"><a href="#tab-change_dokumen" data-toggle="tab">Dok Change</a></li>
						</ul>
						<div class="modal-body">
							<div class="tab-content">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-xs-6">
												...
												<input type="text" class="form-control form-control-hide" name="email" id="email" placeholder="email@kiranamegatara.com">
											</div>
										</div>
									</div>	
								</div>
								...
								<div class="tab-pane" id="tab-nilai">
									<table class="table table-bordered">
										...
										<tbody>
											...
											echo '<td><input type="text" class="form-control col-xs-2" name="total_nilai" readonly width="50px"></td>';
											echo '<td><input type="text" class="form-control col-xs-2" name="total_penilaian" readonly width="50px"></td>';
									...
									<div class="form-group">
										<div class="row">
											<div class="col-xs-6">
												...
												<select class="form-control select2modal" name="id_jenis_vendor" id="id_jenis_vendor" required="required">
													<?php
											...
											<div class="col-xs-6">
												...
												<select class="form-control select2 col-sm-12" multiple="kualifikasi_spk" name="kualifikasi_spk[]" id="kualifikasi_spk" data-placeholder="Pilih Kualifikasi">
													<?php
														foreach($kualifikasi as $dt){
															echo"<option value='".$dt->id_kualifikasi_spk."'>".$dt->kualifikasi_spk."</option>";
														}
											...
											<div class="col-xs-6">
												...
												<select class="form-control select2modal form-control-hide" name="add_alasan" id="add_alasan" required="required">
													<?php
														...
														echo "<option value='Req HO'>Req HO</option>";
													?>
												</select>
											</div>
											<div class="col-xs-6">
								...
								<!--change data-->
								<div class="tab-pane" id="tab-change_data">
									<div id='show_tab_change'></div>
								</div>								
								<!--change dokumen-->
								<div class="tab-pane" id="tab-change_dokumen">
									<div class="form-group">
										<div class="row">
											<div class="col-xs-6">
												<label for="id_tipe">Jenis Vendor</label>
												<select class="form-control select2modal" name="id_jenis_vendor_temp" id="id_jenis_vendor_temp" disabled="disabled">
													<?php
														echo "<option value='0'>Pilih Tipe Vendor</option>";
														foreach($jenis as $dt){
															echo"<option value='".$dt->id_jenis_vendor."'>".$dt->jenis_vendor."</option>";
											...
											<div class="col-xs-6">
												<label for="id_kategori">Kualifikasi Vendor</label>
												<select class="form-control select2 col-sm-12" multiple="kualifikasi_spk_temp" name="kualifikasi_spk_temp[]" id="kualifikasi_spk_temp" data-placeholder="Pilih Kualifikasi"  disabled="disabled">
													<?php
														foreach($kualifikasi as $dt){
															echo"<option value='".$dt->id_kualifikasi_spk."'>".$dt->kualifikasi_spk."</option>";
														}
									...
									<div class="form-group">
										<div class="row">
											<div class="col-xs-6">
												<div id="show_dokumen_jenis_temp"></div>  
											</div>
											<div class="col-xs-6">
												<div id="show_dokumen_kualifikasi_temp"></div>  
											</div>
										</div>
									</div>	
								</div>								
						...
						<div class="modal-footer"> 
							...
							<input id="action_detail" name="action_detail" type="text">
							...
							<!--<button id="btn_approve_sap" type="button" class="btn btn-primary" name="btn_approve_sap">Approve SAP</button>-->
							<!--
				...
				<div class="nav-tabs-custom" id="tabs-edit">
					<form role="form" class="form-transaksi-extend_vendor" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							...
							<button id="btn_save_extend" type="button" class="btn btn-primary" name="btn_save_extend">Submit</button>
							<button id="btn_decline_extend" type="button" class="btn btn-danger" name="btn_decline_extend">Decline</button>
							<button id="btn_save_extend_sap" type="button" class="btn btn-primary" name="btn_save_extend_sap">Approve SAP</button>
						</div>
					</form>
				</div>
			</div>
