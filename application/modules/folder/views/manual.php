	...
	<section class="content">
		<div class="box box-success">
			<div class="box-header">
	            <h3 class="box-title" id="title-top"><strong>USER MANUAL</strong></h3>
			    ...
			    <?php 
			    	...
			    	if ($nik == "8347" || $nik == "8944" || $nik == "7143" || $nik == "5649") {
			    		echo "
			    			<div class='btn-group pull-right pr'>
				              <button type='button' class='btn btn-sm btn-success'><i id='tanda' class='fa fa-cogs icons_white' style='padding-left:3px;'></i>SETTING USER MANUAL</button>
				              ...
				              <ul class='dropdown-menu' role='menu'>
				                ...
				                <li id='set_aksesmanual'><a href='javascript:void(0)'><i class='fa fa-cogs icons_green_km'></i>SETTING AKSES</a></li>
				              </ul>
				            </div>
			    		";
			    	}
...
<script src="<?php echo base_url() ?>assets/apps/js/folder/manual.js"></script>
