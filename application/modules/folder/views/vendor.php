...
<link rel="stylesheet" href="<?php echo base_url() ?>assets/apps/css/folder/knowledge.css">
	...
	<section class="content">
		<div class="box box-success">
			<div class="box-header">
	            <h3 class="box-title" id="title-top"><strong>DOKUMEN VENDOR</strong></h3>
			    ...
			    <?php 
			    	...
			    	if ($nik == "8347" || $nik == "8944" || $nik == "7143" || $nik == "5649") {
			    		...
			    		echo "
			    			<div class='btn-group pull-right pr'>
				              <button type='button' class='btn btn-sm btn-success'><i id='tanda' class='fa fa-cogs icons_white' style='padding-left:3px;'></i>SETTING DOKUMEN VENDOR</button>
				              ...
				              <ul class='dropdown-menu' role='menu'>
				                ...
				                <li id='set_aksesknowledge'><a href='javascript:void(0)'><i class='fa fa-cogs icons_green_km'></i>SETTING AKSES</a></li>
				              </ul>
				            </div>
			    		";
			    	}
		    		...
		    		<div class="modal-header">
		      		...
		      		<div class="modal-body">
			      		<div class="row">
				      		<div class="col-sm-12">
		          				<div class="form-group">
		          					<label>Folder Namexx</label>
		        					<input type="text" name="folder_names" id="folder_names" class="text-left form-control col-sm-12">
			      		...
			      		<div class="row">
				      		<div class="col-sm-12">
		          				<div class="form-group">
		          					...
		          					<input type="text" name="id_folder">
		          					<input type="text" name="apps" value="vendor">
              						<input type="text" name="name">
		          					<input type="file" class="form-control" id="fileUpload" name="fileUpload[]" multiple="multiple" required="required">
		          					<label style="color: red; font-weight: 500;">*File format (.pdf | .docx | .doc | .xls | .xlsx | .swf | .vsd | .mp4 | .webm).</label>
		...
		<!-- Setting Modal KNOWLEDGE Folder -->
...
<script src="<?php echo base_url() ?>assets/plugins/videojs/video-js.min.js"></script>
<script src="<?php echo base_url() ?>assets/apps/js/folder/vendor.js"></script>
