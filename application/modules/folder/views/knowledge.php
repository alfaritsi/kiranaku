	...
	<section class="content">
		<div class="box box-success">
			<div class="box-header">
	            <h3 class="box-title" id="title-top"><strong>KNOWLEDGE MANAGEMENT</strong></h3>
			    ...
			    <?php 
			    	...
			    	if ($nik == "8347" || $nik == "8944" || $nik == "7143" || $nik == "5649") {
			    		...
			    		echo "
			    			<div class='btn-group pull-right pr'>
				              <button type='button' class='btn btn-sm btn-success'><i id='tanda' class='fa fa-cogs icons_white' style='padding-left:3px;'></i>SETTING KNOWLEDGE</button>
			      		...
			      		<div class="row">
				      		<div class="col-sm-12">
		          				<div class="form-group">
		          					...
		          					<input type="hidden" name="apps" value="knowledge">
              						<input type="hidden" name="name">
		          					<input type="file" class="form-control" id="fileUpload" name="fileUpload[]" multiple="multiple" required="required">
		          					<label style="color: red; font-weight: 500;">*File format (.pdf | .docx | .doc | .xls | .xlsx | .ppt | .pptx | .swf | .vsd | .mp4 | .mp3).</label>
...
<script src="<?php echo base_url() ?>assets/apps/js/folder/knowledge.js"></script>
