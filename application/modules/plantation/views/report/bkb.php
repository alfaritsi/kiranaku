            ...
            <div class="col-sm-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h1 class="box-title">Data BKB</h1>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover table-striped" id="sspTable" data-ordering="true" data-scrollx="true" data-bautowidth="true" data-pagelength="25" style="min-width: 1500px !important">
                                    <thead>
                                        <th>No BKB</th>
                                        <th>Pabrik</th>
                                        <th>Tanggal</th>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/apps/js/plantation/report/gi.js?<?php echo time(); ?>"></script>