                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <!-- <tr>
                                        <td style="width: 8%;"><span class="label label-primary">Sent</span></td>
                                        <td>: Data sudah tersubmit ke SAP</td>
                                    </tr> -->
                                    <tr>
                                        <td style="width: 8%;"><span class="label label-success">Success</span></td>
                                        <td>: Submit SAP Berhasil. Menunggu Pembentukan nomor PO</td>
                                    </tr>
                                    <tr>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/apps/js/plantation/transaksi/po/data_po.js"></script>