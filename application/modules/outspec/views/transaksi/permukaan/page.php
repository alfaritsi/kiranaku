            ...
            <div class="col-sm-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title"><strong>Data Cek Permukaan + Label</strong></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<script src="<?php echo base_url() ?>assets/apps/js/outspec/transaksi/permukaan/page.js?<?php echo time(); ?>"></script>