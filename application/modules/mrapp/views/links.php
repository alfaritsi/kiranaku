        ...
        <div class="row">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered my-datatable-extends-order">
                            ...
                            <?php
                            foreach ($datas as $dt) {
                                $enId = $this->generate->kirana_encrypt($dt->id_report_link);
            ...
            <div class="col-sm-4">
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" class="form-mrapp-report-links" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="parameter_nama">Link Report</label>
                                <select required class="form-control select2" id="id_report_link"
                                        name="id_report_link">
                                    <?php
                                    foreach ($reports as $value) {
                                        echo '<option value="' . $value->id_report . '">' . $value->nama_report . '</option>';
                                    } ?>
                                </select>
                            </div>
                        </div>
                        <div class="box-footer">
                            ...
                            <input type="hidden" name="id_report_link_old" id="id_report_link_old">
...
<script src="<?php echo base_url() ?>assets/apps/js/mrapp/links.js"></script>
<style>
    .small-box .icon {
        top: -13px;
    }
