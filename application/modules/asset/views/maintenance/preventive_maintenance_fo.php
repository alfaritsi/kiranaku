                ...
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <div class="btn-group pull-right">
                            <?php
								if (isset($akses)) {
									if ($akses->role == 'OPERATOR'){
										echo '<button type="button" class="btn btn-sm btn-warning" id="add_button_pm"><i class="fa fa-calendar-o"></i> Tambah PM</button>';
										// echo '<button type="button" class="btn btn-sm btn-success" id="add_button_perbaikan"><i class="fa fa-wrench"></i> Tambah Perbaikan</button>';
                                    }
								}
							?>
                        </div>
...
<?php $this->load->view('maintenance/includes/_modal_pm_perawatan_fo') ?>
...
<script src="<?php echo base_url() ?>assets/apps/js/asset/transaksi/preventive_maintenance_fo.js"></script>
