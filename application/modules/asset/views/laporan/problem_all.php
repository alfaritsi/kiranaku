			...
			<div class="col-sm-12">
	    		<div class="box box-success">
	          		<div class="box-header">
						...
						<button type="button" class="btn btn-sm btn-default pull-right" id="excel_button">Export Excel</button> 
						<input id="id_pabrik" name="id_pabrik" value="<?php echo $id_pabrik;?>" type="hidden">
											...
											<div class="tab-pane active" id="tab-data">
												...
												<div class="form-group">		
													<div class="row">
														...
														<div class="col-xs-8">
															<select class="form-control select2modal" name="id_kondisi" id="id_kondisi">
																<?php
...
<script src="<?php echo base_url() ?>assets/apps/js/asset/laporan/problem_all.js"></script>
