            ...
            <div class="col-sm-8">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        <li class="pull-left header"><strong>Master Kegiatan dan Service</strong></li>
            ...
            <div class="col-sm-4">
                <div class="box box-success" id="box-add-kegiatan">
                    <div class="box-header with-border">
                        ...
                        <button type="button" class="btn btn-sm btn-default pull-right hidden" id="btn-new-kegiatan">
                            Buat Kegiatan Baru
                        </button>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kegiatan" id="kegiatan"
                                       placeholder="Masukkkan Nama Kegiatan" required="required">
                            </div>
                            <div class="form-group">
                                <label for="kegiatan">Keterangan</label>
                                <textarea class="form-control" name="ket_kegiatan" id="ket_kegiatan"
                                          placeholder="Masukan Keterangan Kegiatan" required="required"></textarea>
                            </div>
                        </div>
                ...
                <div class="box box-success hidden" id="box-add-service">
                    <div class="box-header with-border">
                        ...
                        <button type="button" class="btn btn-sm btn-default pull-right hidden" id="btn-new-service">Buat
                            Service Baru
                        </button>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="service" id="service"
                                       placeholder="Masukkkan Nama Service" required="required">
                            </div>
                            <div class="form-group">
                                <label for="Service">Keterangan</label>
                                <textarea class="form-control" name="ket_service" id="ket_service"
                                          placeholder="Masukan Keterangan Service" required="required"></textarea>
                            </div>
                        </div>
                        <div class="box-footer">
...
<script src="<?php echo base_url() ?>assets/apps/js/asset/master/keterangan_it.js"></script>
