            ...
            <div class="col-sm-4">
                <div class="box box-success" id="box-add-komponen">
                    <div class="box-header with-border">
                        ...
                        <button type="button" class="btn btn-sm btn-default pull-right hidden" id="btn-new-komponen">
                            Buat Komponen Baru
                        </button>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <form role="form" class="form-master-komponen">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kategori_komponen" id="kategori_komponen"
                                       value="<?php echo $kategori; ?>" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label for="merk">Jenis</label>
                                <input type="text" class="form-control" name="jenis_komponen" id="jenis_komponen"
                                       value="<?php echo $judul; ?>" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label for="merk">Komponen</label>
                                <input type="text" class="form-control" name="jenis_detail" id="jenis_detail"
                                       required="required" placeholder="Masukkkan Komponen">
                            </div>
                            <div class="form-group">
                                <label for="merk">Keterangan</label>
                                <textarea class="form-control" name="ket_komponen" id="ket_komponen"
                                          placeholder="Masukan Keterangan" required="required"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="kolom_aset">Kolom Aset</label>
                                <span class="help-block">Digunakan untuk update nilai otomatis ketika digunakan pada proses perbaikan aset dengan pilihan upgrade komponen</span>
                                <select class="form-control select2" name="kolom_aset" id="kolom_aset"
