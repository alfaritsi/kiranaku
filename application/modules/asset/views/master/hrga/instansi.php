    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="row">
                <div class="col-sm-8">
                	<div class="box box-success">
			          	<div class="box-header">
			            	<h3 class="box-title"><strong>Master Instansi - Jenis <?php echo $judul; ?> </strong></h3>
			          	</div>
						<div class="box-body">
                ...
                <div class="col-sm-4">
			        <div class="box box-success" id="box-add-instansi">
			          <div class="box-header with-border">
			              <h3 class="box-title title-form-instansi"><strong>Buat Instansi Baru</strong></h3>
			              <button type="button" class="btn btn-sm btn-default pull-right hidden" id="btn-new-instansi">Buat  Instansi Baru</button>
			          </div>
			          <!-- /.box-header -->
			          <!-- form start -->
			          <form role="form" class="form-master-instansi">
			            <div class="box-body">
			              ...
			              <div class="form-group">
			                ...
			                <input type="text" class="form-control" name="instansi" id="instansi" placeholder="Masukkkan Instansi" required="required">
			              </div>
			              <div class="form-group">
