			...
			<div class="col-sm-12">
	    		<div class="box box-success">
	          		<div class="box-header">
					    ...
					    <form method="POST" id="filterform" action="<?php echo base_url() ?>she/report/limbahair/cemaraktual" class="filter-airlimbah_cemaraktual" role="form">
						        ...
						        <tr>
					                ...
					                <?php
						                ...
						                foreach($reporth as $dt){
						                  if($dt->param == 1){
						                  	echo "<th class='text-center'>".$dt->parameter."</th>";
						                  }else {
						                  	echo "<th class='text-center'>".$dt->parameter."(Ton / Periode)</th>";
						                  }
						                  $kolom = $kolom + 1;
						                }
					                ?>									
				                ...
				                <?php
				                	if($kolom > 0){
						                foreach($report as $result){
						                  ...
						                  $i = 0;
						                  for ($i=1; $i < $kolom; $i++) { 
		                    				  echo "<td align='right'>".number_format($dt[$i],2,",",".")."</td>";
						                  }
						                  // echo "<td>".$dt[3]."</td>";
...
<script src="<?php echo base_url() ?>assets/apps/js/she/report/rpt_cemaraktual.js"></script>
