					                  ...
					                  echo "<td>
					                      ...
					                      if($dt->na == null){ 
					                        echo "<li><a href='#' class='edit' data-edit='".$dt->id."' data-toggle='modal' data-target='#modal-form'><i class='fa fa-pencil-square-o'></i> Edit</a></li>
												  ...
												  <li><a href='#' class='history' data-edit='".$dt->id."'><i class='fa fa-h-square'></i> History</a></li>";
					                      }
					                      if($dt->na != null){
	        ...
	        <form role="form" class="form-master-bakumutu">
	          <div class="modal-content">
	            ...
	            <div class="modal-body" style="min-height:300px;">
	              ...
	              <div class="col-md-6">
	                <div class="form-group">
	                  <label for="bakumutu" class="list-group-item list-group-item-info text-center" style="width:100%;">Acuan<br>Regulasi</label>
	                </div>
	              </div>
	              ...
	              <div class="col-md-1">
	                <div class="form-group">
	                  <label>Limit :</label>
	                  <input type="text" name="limit_uji" id="limit_uji" style="width:100%;height:32px;text-align:right;padding:10px;" class="init">
	                </div>
	              </div>
	              <div class="col-md-1">
	                <div class="form-group">
	                  <label>Min :</label>
	                  <input type="text" name="min_uji" id="min_uji" style="width:100%;height:32px;text-align:right;padding:10px;" class="init">
	                </div>
	              </div>
	              <div class="col-md-1">
	                <div class="form-group">
	                  <label>Max :</label>
	                  <input type="text" name="max_uji" id="max_uji" style="width:100%;height:32px;text-align:right;padding:10px;" class="init">
	                </div>
	              </div>
	              <div class="col-md-1">
	                <div class="form-group">
	                  <label>Limit :</label>
	                  <input type="text" name="limit_cemar" id="limit_cemar" style="width:100%;height:32px;text-align:right;padding:10px;" class="init">
	                </div>
	              </div>
	              <div class="col-md-1">
	                <div class="form-group">
	                  <label>Min :</label>
	                  <input type="text" name="min_cemar" id="min_cemar" style="width:100%;height:32px;text-align:right;padding:10px;" class="init">
	                </div>
	              </div>
	              <div class="col-md-1">
	                <div class="form-group">
	                  <label>Max :</label>
	                  <input type="text" name="max_cemar" id="max_cemar" style="width:100%;height:32px;text-align:right;padding:10px;" class="init">
	                </div>
	              </div>
	              <div class="col-md-6">
	                <div class="form-group">
	                  <label>Acuan Regulasi :</label>
	                  <input maxlength="100" type="text" name="regulasi" id="regulasi" style="width:100%;height:32px;text-align:left;padding:10px;" class="init">
	                </div>
	              </div>
	            </div>
						...
						<div class="modal-content">
							<form role="form" class="form-transaksi-input">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">History Master Baku Mutu</h4>
								</div>
									...
									<div class="form-group">	
										<div class="row">
											<div class="col-xs-4">
												...
												<input type="text" class="form-control" name="kategori" id="kategori_val" disabled>
											</div>
											<div class="col-xs-3">
												<label for="jenis">Jenis</label>
												<input type="text" class="form-control" name="jenis" id="jenis_val" disabled>
											</div>
											<div class="col-xs-3">
												<label for="parameter">Parameter</label>
												<input type="text" class="form-control" name="parameter" id="parameter_val" disabled>
											</div>
										</div>
									</div>
