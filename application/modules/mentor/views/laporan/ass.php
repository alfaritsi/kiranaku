	    		...
	    		<div class="box box-success">
	          		<div class="box-header">
						...
						<div class="btn-group pull-right">
							<button type="button" class="btn btn-success" id="export_excel_ass">Export To Excel</button>
						</div>
...
<script src="<?php echo base_url() ?>assets/apps/js/mentor/laporan/ass.js"></script>
