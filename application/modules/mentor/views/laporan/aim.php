	    		...
	    		<div class="box box-success">
	          		<div class="box-header">
						...
						<div class="btn-group pull-right">
							<button type="button" class="btn btn-success" id="export_excel_aim">Export To Excel</button>
						</div>
	          		</div>
	          		<!-- /.box-header -->
		          	<div class="box-body">
...
<script src="<?php echo base_url() ?>assets/apps/js/mentor/laporan/aim.js"></script>
