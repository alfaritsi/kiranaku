                                ...
                                <fieldset class="fieldset-warning fieldset-4px-rad">
                                    ...
                                    <script type="text/template" id="biaya_template">
                                        <tr class="template-trip">
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input id="biaya_{no}_rate"
                                                        required value="0"
                                                        name="biaya[{no}][rate]" numeric-min="0"
                                                        class="form-control biaya-rate text-right numeric" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                            ...
                                            <td align="center">
												<div id="div-lampiran-{no}">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="btn-group btn-sm no-padding">
                                                            <a class="btn btn-default btn-sm fileinput-exists fileinput-zoom"
                                                            ...
                                                            <a href="#" class="btn btn-pinterest fileinput-exists btn-sm" data-dismiss="fileinput"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </div>
												</div>
                                            </td>
...
<script src="<?php echo base_url() ?>assets/apps/js/travel/spd/edit_deklarasi.js?<?php echo time(); ?>"></script>
