<table class="table table-bordered table-responsive my-datatable-extends-order table-striped" id="table-deklarasi-history"
				...
				<?php
					if(isset($d->deklarasi_approval_status)){
						if($d->deklarasi_approval_level==99){
							...
							}else if(($d->deklarasi_approval_level==1)and($d->deklarasi_approval_status==3)){
