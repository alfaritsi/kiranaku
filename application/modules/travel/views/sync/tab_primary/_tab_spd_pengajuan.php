<form id="form-sync-pengajuan">
    <div class="row">
        <div class="col-md-offset-9 col-md-3">
            <div class="btn-group btn-group-sm pull-right" style="padding-bottom: 10px">
                ...
                <!-- <a href="javascript:void(0)" id="btn-sync-spd" name="btn-sync-spd" class="btn btn-sm btn-success btn-sync-spd"><i
    ...
    <input type="hidden" id="pengajuan-disetujui" name="pengajuan-disetujui">
    <table class="table table-bordered table-responsive  table-striped" id="table-pengajuan"
                ...
                <td>
                    <div class='input-group-btn'>
                        ...
                        <ul class='dropdown-menu pull-right'>
                            <?php
                                // $this->generate->kirana_decrypt($d->id_travel_header)
                                echo '  
                                        <li>
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-md-12 text-center">                
                <a href="javascript:void(0)" id="btn-sync-spd" name="btn-sync-spd" 
                    class="btn btn-sm btn-success btn-sync-spd">
