<form id="form-sync-declare">    
    <div class="row">
        <div class="col-md-offset-9 col-md-3">
            <div class="btn-group btn-group-sm pull-right" style="padding-bottom: 10px">
                <!-- <a href="javascript:void(0)" id="btn-sync-declaration" class="btn btn-sm btn-success btn-sync-declaration"><i
                            class="fa fa-refresh"></i>
                    &nbsp;Synchronize</a> -->
            </div>
        </div>
    </div>
    <table class="table table-bordered table-responsive table-striped" id="table-declare"
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-md-12 text-center">                
                <a href="javascript:void(0)" id="btn-sync-declaration" name="btn-sync-declaration" 
                    class="btn btn-sm btn-success btn-sync-declaration">
                    <i class="fa fa-refresh"></i>
                    &nbsp;Synchronize
                </a>
                <!--<a href="javascript:void(0)" class="btn btn-sm btn-success btn-export-spd-declare"
                    data-export="sync_deklarasi" id="excel_button_deklarasi"> 
