                        ...
                        <tr>
                            <td style="padding: 20px;">
                                ...
                                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <strong>Konfirmasi Penerimaan Perjalanan Dinas</strong>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <table role="presentation" border="0" width="100%" cellspacing="0"
                                    ...
                                    <!-- <?php if (TR_EMAIL_DEBUG) : ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><?php echo is_array($email_original) ? join(', ', $email_original) : $email_original; ?></td>
                                        </tr>
                                    <?php endif; ?> -->
                                    <tr>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo $detail->tanggal_berangkat; ?></td>
                                    </tr>
                                    <tr>
                                        <td width="30%">
                                            <p>
                                        ...
                                        <td style="text-align: right;"><?php echo $detail->tanggal_kembali; ?></td>
                                    </tr>
                                    <tr>
                                        <td width="30%">
                                            <p>
                                                <strong>Kendaraan Penjemput</strong>
                                            </p>
                                        </td>
                                        <td style="text-align: right; text-transform: capitalize"><?php echo $transportasi->nama; ?></td>
                                    </tr>
                                    <tr>
                                        <td width="30%">
                                            <p>
                                                <strong>Ketersediaan Mess</strong>
                                            </p>
                                        </td>
                                        <td style="text-align: right; text-transform: capitalize"><?php echo $detail->mess_available ? 'Ya' : 'Tidak'; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
