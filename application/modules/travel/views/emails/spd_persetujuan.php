                        ...
                        <tr>
                            <td style="padding: 20px;">
                                ...
                                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <strong>Konfirmasi Pengajuan Perjalanan Dinas</strong>
                                        </td>
                            ...
                            <td align="left"
                                ...
                                <table role="presentation" border="0" width="100%" cellspacing="0"
                                    ...
                                    <tr>
                                        <td width="30%">
                                            <p>
                                                <strong>Catatan Persetujuan Sebelumnya</strong>
                                            </p>
                                        </td>
                                        <td style="text-align: right; text-transform: capitalize"><?php echo $data->approval_catatan; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
