<?php
$color = "#AAAAAA";
switch ($dataDeklarasi->status_color) {
    case "bg-green":
        $color = "#008d4c";
        break;
    case "bg-blue":
                        ...
                        <tr>
                            <td style="padding: 20px;">
                                ...
                                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <strong>Konfirmasi Deklarasi Perjalanan Dinas</strong>
                                        </td>
                            ...
                            <td align="left"
                                ...
                                <table role="presentation" border="0" width="100%" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right; text-transform: capitalize"><?php echo $this->generate->convert_rupiah($dataDeklarasi->total_biaya); ?></td>
                                    </tr>
                                    <tr>
                                        <td width="30%">
                                            <p>
                                        ...
                                        <td style="text-align: right; text-transform: capitalize"><?php echo $this->generate->convert_rupiah($dataDeklarasi->total_bayar); ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
