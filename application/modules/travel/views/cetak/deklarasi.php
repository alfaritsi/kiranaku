...
<body>
    ...
    <main>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="4px" style="table-layout: fixed; margin: 5px 0;">
            ...
            <tr>
                <td class="text-center" style="border: none !important;">
                    ...
                    <br>
                    <span style="font-size: 7pt;">Atasan (minimal Division Head)</span>
                </td>
                <td class="text-center" style="border: none !important;">
                    <span style="text-decoration: underline;">
                        <?php
                    ...
                    <br>
                    <span style="font-size: 7pt;">HR System Dev. & Payroll Dept. Head</span>
                </td>
                <td class="text-center" style="border: none !important;">
                    <span style="text-decoration: underline;">
                        <?php
        ...
        <table width="100%" cellspacing="0" cellpadding="4px" class="tb-detail">
            <tr>
                <td width="50%" style="border-right: none;">
                    <b>PENGAJUAN LIBUR PENGGANTI :</b><br>
                    <i>- Tiba di Bandara Jakarta lebih dari pukul 17.00 WIB</i><br>
                    <i>- Keberangkatan dari Bandara Jakarta kurang dari pukul 08.00 WIB</i>
                    <br><br>
                </td>
                <td style="border-left: none;">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="4px">
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            if ($data['cuti_pengganti']) {
                                foreach ($data['cuti_pengganti'] as $aktifitas) {
                                    echo '<tr>
                                        <td align="center">' . $i . '</td>
                                        <td>' . $aktifitas->hari . '</td>
                                        <td>' . $aktifitas->tanggal_cuti_format . '</td>
                                    </tr>';
                                    $i++;
                                }
                            } else {
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="4px" style="table-layout: fixed; margin: 0;">
            <tr>
                <td colspan="2" style="border-right: none;"></td>
                <td align="center" style="border-left: none;">Jakarta, <?php echo $data['pengajuan_deklarasi']->tanggal_buat_format; ?></td>
            </tr>
            <tr>
                <td align="center" style="border: none;">Disetujui *)</td>
