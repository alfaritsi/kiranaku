		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="box box-success">
					...
					<form role="form" class="form-master-pic_sync">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div>
									<input type="hidden" class="form-control" name="personal_subarea_hidden" 
										id="personal_subarea_hidden">
									<select class="form-control select2" id="personal_subarea" 
										name="personal_subarea" style="width: 100%;" 
										data-placeholder="Silahkan Pilih Personal Sub Area" 
										required="required">
					                	<?php
						...
						<div class="box-footer">
							<input type="hidden" name="id_pic_sync" />
...
<script src="<?php echo base_url() ?>assets/apps/js/travel/master/mpic_sync.js"></script>
