        ...
        <div class="row">
                                        ...
                                        <div class='input-group-btn'>
                                            ...
                                            <ul class='dropdown-menu pull-right'>
                                                <li><a href='#' class='edit'
                                                       data-edit='<?php echo $this->generate->kirana_encrypt($d->id_travel_costcenter_expense); ?>'><i
                                                                class='fa fa-pencil-square-o'></i> Edit</a></li>
                                                <li><a href='#' class='delete'
                                                       data-delete='<?php echo $this->generate->kirana_encrypt($d->id_travel_costcenter_expense); ?>'><i
            ...
            <div class="col-sm-4">
                <div class="box box-success">
                    ...
                    <form role="form" class="form-costcenter-expenses">
                        <div class="box-body">
                            ...
                            <div class="form-group no-padding">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>
                                            <input type="radio" value="1" name="domestik" checked />
                                            Domestik
                                        </label>
                                    </div>
                                    <div class="col-md-4">
                                        <label>
                                            <input type="radio" value="0" name="domestik" />
                                            Luar Negeri
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="id_travel_costcenter_expense"/>
...
<script src="<?php echo base_url() ?>assets/apps/js/travel/master/costcenter_expenses.js"></script>
