			...
			<div class="col-sm-12">
	    		<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="col-sm-4">: <?php echo $topik_trainer[0]->nama_trainer.' ('.$topik_trainer[0]->asal_trainer.')';?></div><br>
								...
								foreach($tanya as $t){
									...
									foreach($feedback_nilai as $fn){
										...
										if(($t->id_karyawan==base64_decode($this->session->userdata("-nik-")))and($t->id_batch==$batch[0]->id_batch)and($t->id_feedback_nilai==$fn->id_feedback_nilai)){
											echo"
												<td align='center'><input checked='checked' type='radio' name='$nama' onclick=\"save_evaluasi('".$batch[0]->id_batch."','".base64_decode($this->session->userdata("-nik-"))."','".$t->id_feedback_pertanyaan."','".$fn->id_feedback_nilai."',".$t->id_feedback_kategori.",'".$topik_trainer[0]->id_trainer."')\"></td>
											";
										}else{
											echo"
												<td align='center'><input type='radio' name='$nama' onclick=\"save_evaluasi('".$batch[0]->id_batch."','".base64_decode($this->session->userdata("-nik-"))."','".$t->id_feedback_pertanyaan."','".$fn->id_feedback_nilai."',".$t->id_feedback_kategori.",'".$topik_trainer[0]->id_trainer."')\"></td>
											";
										}
									}		
									echo "</tr>";
...
<script src="<?php echo base_url() ?>assets/apps/js/klems/transaksi/evaluasi_sesi.js"></script>
