		...
		<div class="row">
				              		...
				              		echo "<td>
				                          <div class='input-group-btn'>
				                            ...
				                            <ul class='dropdown-menu pull-right'>";
												if($dt->na == 'n'){ 
												echo "<li><a href='javascript:void(0)' class='edit' data-edit='".$generate->kirana_encrypt($dt->id_nilai_kategori)."'><i class='fa fa-pencil-square-o'></i> Edit </a></li>
													  <li><a href='javascript:void(0)' class='delete' data-delete='".$generate->kirana_encrypt($dt->id_nilai_kategori)."'><i class='fa fa-trash-o'></i> Hapus</a></li>";
												}
												if($dt->na == 'y'){
												echo "<li><a href='javascript:void(0)' class='set_active-nil_kategori' data-activate='".$generate->kirana_encrypt($dt->id_nilai_kategori)."'><i class='fa fa-check'></i> Set Aktif</a></li>";
												}
									echo " 	</ul>
				                          </div>
				                        </td>";
			...
			<div class="col-sm-4">
				<div class="box box-success">
		          	...
		          	<!-- /.box-header -->
		          	<!-- form start -->
		          	<form role="form" class="form-master-nilai_kategori">
	            		<div class="box-body">
		            	...
		            	<div class="box-footer">
		             		<input type="hidden" name="id_nilai_kategori">
...
<script src="<?php echo base_url() ?>assets/apps/js/klems/master/nil_kategori.js"></script>
