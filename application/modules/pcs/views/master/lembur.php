		...
		<div class="row">
		           		...
		           		<table class="table table-bordered table-striped my-datatable-extends-order">
			              	...
			              	<tbody>
				              	...
				              	foreach($lembur as $dt){
				                      ...
				                      if($dt->active == 1){ 
				                        echo "<li><a href='javascript:void(0)' class='delete' data-delete='".$generate->kirana_encrypt($dt->id_mlembur)."'><i class='fa fa-trash-o'></i> Hapus</a></li>";
				                      }
				                      if($dt->active == 0){
				                        echo "<li><a href='javascript:void(0)' class='set_active-lembur' data-activate='".$generate->kirana_encrypt($dt->id_mlembur)."'><i class='fa fa-check'></i> Set Aktif</a></li>";
				                      }
				                  echo "    </ul>
				                          </div>
				                        </td>";
			...
			<div class="col-sm-6">
				<div class="box box-success">
		          	...
		          	<!-- /.box-header -->
		          	<!-- form start -->
		          	<form role="form" class="form-master-lembur">
	            		<div class="box-body">
...
<script src="<?php echo base_url() ?>assets/apps/js/pcs/master/lembur.js"></script>
