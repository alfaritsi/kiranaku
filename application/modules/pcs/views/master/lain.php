		...
		<div class="row">
		           		...
		           		<table class="table table-bordered table-striped my-datatable-extends-order">
			              	...
			              	<tbody>
				              	...
				              	foreach($lain as $dt){
				                      ...
				                      if($dt->active == 1){ 
				                        echo "<li><a href='javascript:void(0)' class='delete' data-delete='".$generate->kirana_encrypt($dt->id_mlain)."'><i class='fa fa-trash-o'></i> Hapus</a></li>";
				                      }
				                      if($dt->active == 0){
				                        echo "<li><a href='javascript:void(0)' class='set_active-lain' data-activate='".$generate->kirana_encrypt($dt->id_mlain)."'><i class='fa fa-check'></i> Set Aktif</a></li>";
				                      }
				                  echo "    </ul>
				                          </div>
				                        </td>";
			...
			<div class="col-sm-6">
				<div class="box box-success">
		          	...
		          	<!-- /.box-header -->
		          	<!-- form start -->
		          	<form role="form" class="form-master-lain">
	            		<div class="box-body">
		            	...
		            	<div class="box-footer">
		             		<input type="hidden" name="id_mlain">
...
<script src="<?php echo base_url() ?>assets/apps/js/pcs/master/lain.js"></script>
