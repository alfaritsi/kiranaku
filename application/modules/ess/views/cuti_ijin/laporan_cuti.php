            ...
            <div class="col-sm-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title"><strong>Laporan Cuti Karyawan</strong></h3>
                    </div>
                    <div class="box-body">
                                ...
                                <div class="col-md-offset-4 col-md-2">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <label class="input-group-addon" for="form">Form</label>
                                            <select class="select2 form-control" id="form" name="form">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="select2 form-control" id="id_cuti_status" name="id_cuti_status">
...
<script src="<?php echo base_url() ?>assets/apps/js/ess/cuti_laporan.js"></script>
