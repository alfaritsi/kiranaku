<div class="row">
    <div class="col-md-12">
        <div class="btn-group btn-group-sm pull-right margin-bottom">
            <a href="<?php echo base_url('ess/cutiijin/excel/cuti-pabrik/' . ($manager ? 'mg' : 'kasi')) ?>"
               target="_blank" class="btn btn-sm btn-success"><i class="fa fa-download"></i> &nbsp;Export To SAP</a>
            <a href="javascript:void(0)" id="btn-sync-sap-pabrik" class="btn btn-sm btn-warning"><i
                        class="fa fa-random"></i> &nbsp;Sinkronisasi Data</a>
            <a href="javascript:void(0)" id="btn-sync-sap-pabrik-nik"
               class="btn btn-sm btn-default btn-sync-sap-pabrik-nik">
