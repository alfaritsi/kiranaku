<div class="row">
    ...
    <div class="col-md-offset-6 col-md-3">
        <div class="btn-group btn-group-sm pull-right">
            <a href="javascript:void(0)" id="btn-add-pengajuan-cuti" class="btn btn-sm btn-success btn-add-pengajuan"
               data-form="Cuti" data-saldo='<?php echo json_encode($sisa_cuti) ?>'><i class="fa fa-plus-square"></i>
                &nbsp;Tambah Cuti</a>
        </div>
    </div>
</div>
<table class="table table-bordered table-responsive my-datatable-extends-order table-striped" id="table-pengajuan-cuti"
    ...
    <tbody>
    <?php
    $sisa_cuti_temp = $sisa_cuti['sisa'];
    foreach ($list_pengajuan_cuti as $data):
            ...
            <td>
                <div class='input-group-btn'>
                    ...
                    <ul class='dropdown-menu pull-right'>
                        ...
                        <?php else: ?>
                            <li><a href='javascript:void(0)' class='detail' data-detail='<?php echo $data->enId ?>'
                                   data-saldo="true"><i
                                            class='fa fa-search'></i> Detail</a></li>
                            <li><a href='javascript:void(0)' class='history' data-history='<?php echo $data->enId ?>'><i
...
<div class="well well-sm">
    <ul class="list-unstyled">
        ...
        <li class="text-muted"><strong>Jumlah :</strong> Jumlah hari pengajuan cuti</li>
        <li class="text-muted"><strong>Sisa Saldo :</strong> Saldo cuti setelah pengajuan</li>
