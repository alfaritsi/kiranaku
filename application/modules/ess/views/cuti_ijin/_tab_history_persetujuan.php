                    ...
                    <td>
                        <div class='input-group-btn'>
                            ...
                            <ul class='dropdown-menu pull-right'>
                                ...
                                <?php if($data->id_cuti_status == ESS_CUTI_STATUS_DISETUJUI_ATASAN) : ?>
<!--                                <li class="divider"></li>-->
<!--                                    <li>-->
<!--                                        <a href='javascript:void(0)' class='approval' data-action="disapprove" data-catatan='--><?php //echo $data->enId ?><!--'-->
