<div class="modal fade modal-pengajuan" role="dialog" id="modal-pengajuan-bersalin">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Pengajuan Bersalin</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal form-pengajuan" id="form-pengajuan-bersalin">
                    <input type="hidden" id="id_fbk_bersalin" name="id_fbk"/>
                    <input type="hidden" id="kode_bersalin" name="kode" value="BBNR"/>
                    <input type="hidden" id="fbk_jenis_bersalin" name="fbk_jenis" value="bersalin"/>
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset class="fieldset-primary">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" id="nama_pasien_bersalin"
                                                name="nama_pasien">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="radio radio-inline">
                                            <label>
                                                <input type="radio" name="jenis_persalinan"
                                                       id="jenis_persalinan_normal" value="normal" checked> Normal
                                                <input type="hidden" id="plafon_normal"
                                                       value="<?php echo $plafon_bersalin_normal ?>">
                                            </label>
                                        </div>
                                        <div class="radio radio-inline">
                                            <label>
                                                <input type="radio" name="jenis_persalinan"
                                                       id="jenis_persalinan_cesar" value="cesar"> Cesar
                                                <input type="hidden" id="plafon_cesar"
                                                       value="<?php echo $plafon_bersalin_cesar ?>">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset class="fieldset-warning">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" readonly="readonly" id="plafon_bersalin"
                                                   name="plafon_persalinan" value="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="number" id="jumlah_kwitansi_bersalin"
                                                       name="jumlah_kwitansi" max="5" min="1"
                                                       class="form-control jumlah-kwitansi" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" readonly id="total_bersalin"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                            <textarea class="form-control" id="keterangan_bersalin"
