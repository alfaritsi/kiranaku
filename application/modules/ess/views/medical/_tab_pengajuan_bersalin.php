<?php if($tahun == date('Y')) : ?>
<div class="row">
    <?php if (($plafon_bersalin_normal > 0 || $plafon_bersalin_cesar > 0) && $allow === true): ?>
        <div class="col-md-6">
            <h4>
                <p class="badge bg-yellow">
                    <b><i class="fa fa-umbrella"></i> Normal
                        : <?php echo $this->less->convert_rupiah($plafon_bersalin_normal); ?></b>
                </p>
                <p class="badge bg-yellow">
                    <b><i class="fa fa-umbrella"></i> Cesar
                        : <?php echo $this->less->convert_rupiah($plafon_bersalin_cesar); ?></b>
                </p>
            </h4>
        </div>
        <div class="col-md-3 col-md-offset-3">
            ...
            <div class="btn-group btn-group-sm pull-right">
                <a href="javascript:void(0)" id="btn-add-pengajuan-bersalin"
                   class="btn btn-sm btn-success btn-add-pengajuan"
                   data-form="Bersalin">
                    <i class="fa fa-plus-square"></i> &nbsp Form Bersalin
                </a>
            </div>
            <?php endif; ?>
        </div>
...
<!--        <th>Sisa Plafon</th>-->
    ...
    <tbody>
    <?php foreach ($list_bersalin as $data):
        ...
        <tr>
            ...
            <td><?php echo ucfirst($data->jenis_persalinan) ?></td>
            ...
            <td><a class="detail-kwitansi-disetujui" href="javascript:void(0)" data-disetujui="true"
                   data-kwitansi='<?php echo $data->enId ?>'><span
                            class="badge bg-blue"><?php echo count($data->kwitansi_disetujui); ?> Disetujui</span></a></td>
<!--            <td>-->
<!--                --><?php
//                if($data->kode == 'BBNR')
//                    echo $this->less->convert_rupiah($plafons['sisa_fbk_bersalin_normal']);
//                else
//                    echo $this->less->convert_rupiah($plafons['sisa_fbk_bersalin_cesar']);
//
//                ?>
<!--            </td>-->
