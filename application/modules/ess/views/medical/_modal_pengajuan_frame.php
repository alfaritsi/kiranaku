<div class="modal fade modal-pengajuan" role="dialog" id="modal-pengajuan-frame">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Pengajuan Frame</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal form-pengajuan" id="form-pengajuan-frame">
                    <input type="hidden" id="id_fbk_frame" name="id_fbk"/>
                    <input type="hidden" id="kode_frame" name="kode" value="BBKI"/>
                    <input type="hidden" id="fbk_jenis_frame" name="fbk_jenis" value="frame"/>
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset class="fieldset-primary">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" id="nama_pasien_frame"
                                                name="nama_pasien">
                            ...
                            <fieldset class="fieldset-warning">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" readonly="readonly" id="plafon_frame"
                                                   name="plafon_frame" value="<?php echo $sisa_fbk_frame ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="number" id="jumlah_kwitansi_frame"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" readonly id="total_frame"
                                                   name="total_kwitansi" value="0"
                                                   numeric-total-max="<?php echo $sisa_fbk_frame ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                            <textarea class="form-control" id="keterangan_frame"
