<?php //$sisa_fbk_lensa = 0; ?>
<?php if($tahun == date('Y')) : ?>
<div class="row">
    <?php if ($sisa_fbk_lensa >= 0 && $allow === true): ?>
        <div class="col-md-3">
            <h4>
                <p class="badge bg-yellow">
                    <b><i class="fa fa-umbrella"></i> Sisa Plafon Lensa
                        : <?php echo $this->less->convert_rupiah($sisa_fbk_lensa); ?></b>
                </p>
            </h4>
        </div>
        <div class="col-md-offset-6 col-md-3">
            <?php if ($tahun == date('Y')): ?>
                <div class="btn-group btn-group-sm pull-right">
                    <a href="javascript:void(0)" id="btn-add-pengajuan-lensa"
                       class="btn btn-sm btn-success btn-add-pengajuan"
                       data-form="Lensa">
                        <i class="fa fa-plus-square"></i> &nbsp Form Lensa
                    </a>
                </div>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<table class="table table-bordered table-responsive my-datatable-extends-order table-striped" id="table-pengajuan-lensa"
    ...
    <tbody>
    <?php foreach ($list_lensa as $data):
        ...
        <tr>
            ...
            <td>
                ...
                if($data->id_fbk_status == ESS_MEDICAL_STATUS_DISETUJUI)
                    echo $this->less->convert_rupiah($data->plafon_lensa-$data->total_ganti);
                else
                    echo $this->less->convert_rupiah($plafons['sisa_fbk_lensa']);
                ?>
            </td>
