<div class="modal fade modal-pengajuan" role="dialog" id="modal-pengajuan-jalan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Form Pengajuan Rawat Jalan</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal form-pengajuan" id="form-pengajuan-jalan">
                    <input type="hidden" id="id_fbk_jalan" name="id_fbk"/>
                    <input type="hidden" id="kode_jalan" name="kode" value="BRJL"/>
                    <input type="hidden" id="fbk_jenis_jalan" name="fbk_jenis" value="jalan"/>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <fieldset class="fieldset-primary">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="jenis_sakit_lain hide">
                                            <div class="row">
                                                <div class="col-sm-12">
                            ...
                            <fieldset class="fieldset-warning">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" readonly="readonly" id="plafon_jalan"
                                                   name="plafon_medical" value="<?php 
												   echo ($is_cutoff)?$sisa_fbk_jalan_next:$sisa_fbk_jalan; 
												   ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" readonly id="total_jalan"
                                                   name="total_kwitansi" value="0"
                                                   numeric-total-max="<?php echo ($is_cutoff)?$sisa_fbk_jalan_next:$sisa_fbk_jalan; ?>"
