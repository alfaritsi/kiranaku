            ...
            <div class="col-sm-12">
                ...
                <div class="nav-tabs-custom tab-success">
                    <ul class="nav nav-tabs pull-right">
                        <li class="active">
                            <a href="#tab-kelengkapan" data-toggle="tab">Medical menunggu</a>
                        </li>
                        <li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-kelengkapan">
                            <?php echo $tab_kelengkapan_menunggu; ?>
                        </div>
                        <div class="tab-pane" id="tab-history">
                            <?php echo $tab_kelengkapan_history; ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $this->load->view('_modal_kelengkapan') ?>
...
<script src="<?php echo base_url() ?>assets/apps/js/ess/medical_kelengkapan.js"></script>
