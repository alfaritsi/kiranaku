...
<center style="width: 100%;">
    <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
        Harap segera ditindak lanjuti. Rekapan Konfirmasi Berita Acara Kehadiran yang belum dilakukan pengajuan.
    </div>
    <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
                        ...
                        <tr>
                            <td style="padding: 20px;">
                                ...
                                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <strong>Konfirmasi Berita Acara Kehadiran yang belum dilakukan pengajuan</strong>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            <td align="left"
                                ...
                                <table role="presentation" border="0" width="100%" cellspacing="0"
                                    ...
                                    <tbody>
                                    <?php foreach ($data['list_tidak_lengkap'] as $data): ?>
                                        <tr>
                                            ...
                                            <td style="border-bottom: 1px solid rgb(164,243,162)"><?php echo $data->keterangan_label ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <tr></tr>
                                    </tbody>
