            ...
            <div class="col-sm-12">
                ...
                <div class="nav-tabs-custom tab-success">
                    <ul class="nav nav-tabs pull-right">
                        <li class="active">
                            <a href="#tab-kelengkapan" data-toggle="tab">BAK Disetujui HR</a>
                        </li>
...
<?php $this->load->view('_modal_detail_persetujuan_hr_final') ?>
...
<script src="<?php echo base_url() ?>assets/apps/js/ess/bak_persetujuan_hr_final.js"></script>
