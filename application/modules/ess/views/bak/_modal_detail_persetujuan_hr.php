    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                        ...
                        <div class="col-md-12">
                            <fieldset class="fieldset-warning">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7 ">
                                        <input type="file" class="form-control" name="file" id="ifile"/>
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal-footer text-center">
                ...
                <button name="btn-detail-approve" class="btn btn-success" data-action="approve_hr" type="button">Disetujui</button>
            </div>
        </div>
    </div>
</div>