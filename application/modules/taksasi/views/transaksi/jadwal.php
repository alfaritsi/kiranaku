			...
			<div class="col-sm-4">
				<div class="box box-success">
		          	<div class="box-header with-border">
		              	<h3 class="box-title title-form">Setting Grade Nilai BOKIN</h3>
		          	</div>
		          	<form role="form" class="form-taksasi-jadwal">
	            		<div class="box-body">
							<div class="form-group">
								<label for="nama">Nama Jadwal BOKIN</label>
		                		<input style="text-transform: uppercase" type="text" class="form-control" name="nama" id="nama" placeholder="Nama Jadwal" required="required" readonly>
		                	</div>
							<div class="form-group">
								<label for="tahap">Tahap</label>
		                		<input style="text-transform: uppercase" type="text" class="form-control" name="nama_tahap" id="nama_tahap" placeholder="Nama Tahap" required="required"  readonly>
		                	</div>
							<div class="form-group">
							...
							<div style="width:100%; overflow-x:auto">
								...
								<table class="table table-hover table-bordered table-grade">
									...
									<thead>
										<tr>
											<th class="text-right">Total Bobot</th>
											<th class="text-center" width="20%"><input type="text" class="form-control" name="total_bobot" readonly></th>
											<th class="text-center" width="15%"></th>
										</tr>
									</thead>
								</table>
