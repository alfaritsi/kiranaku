	    		...
	    		<div class="box box-success">
	          		<div class="box-header">
						...
						<div class="float-right">
							<a href='javascript:void(0)' class='history' data-id_data_temp='<?php echo $id_data_temp;?>'>
								<button type="button" class="btn btn-sm btn-default pull-right">History</button>
							</a>
						</div>
	          		</div>
	          		<!-- /.box-header -->
		          	...
		          	<div class="box-body">
			          	...
			          	<div class="row">
			          		<div class="col-sm-6">
			            		<div class="form-group">
				                	<label> Tanggal: </label>
									<input type="text" class="form-control form-control-utama" name="tanggal" id="tanggal" placeholder="Tanggal" required="required">
				            	</div>
			            	</div>
			          		<div class="col-sm-6">
			            		<div class="form-group">
			          	...
			          	<div class="row">
			          		<div class="col-sm-12">
			            		<div class="form-group">
									...
									<textarea class="form-control form-control-utama" name="latar_belakang" id="latar_belakang"  rows="3" placeholder="Masukan Latar Belakang" required="required"></textarea>
				            	</div>
			            	</div>
		            	</div>
						<!--Umum-->
					...
					<div class="box-footer">
						...
						<button type="button" name="btn_approve" id="btn_approve" class="btn btn-success" 
...
<!--modal approve-->
<div class="modal  fade" id="modal_approve" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-sg" role="document">
		<div class="modal-content">
			<div class="col-sm-12">
				<div class="modal-content">
					<form role="form" class="form-bank-transaksi-approve">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title" id="myModalLabel">Approve Bank Specimen</h4>
						</div>
						<div class="modal-body">
							<div class="form-group">
								<label> Catatan: </label>
								<textarea name="catatan" id="catatan" class="form-control" rows="3" placeholder="Masukan Catatan"></textarea>
							</div>
						</div>
						<div class="modal-footer">
							<input id="id_user" name="id_user" type="hidden">
							<input id="id_data_temp" name="id_data_temp" type="hidden">
							<input id="status" name="status" type="hidden">
							<button type="button" name="btn_approve_save" id="btn_approve_save" class="btn btn-success">Approve</button>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="modal-content">
			<div class="col-sm-12">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">History Bank Specimen</h4>
					</div>
					<div class="modal-body">
...
<script src="<?php echo base_url() ?>assets/apps/js/bank/transaksi/detail.js"></script>
