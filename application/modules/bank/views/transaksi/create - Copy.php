			...
			<div class="col-sm-12">
	    		<div class="box box-success">
						...
						<fieldset class="fieldset-success" id="form_pembukaan">
							...
							<fieldset class="fieldset-default">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label>Pihak Prioritasxx 1: </label>
					...
					<div class="box-footer">
						...
						<input id="status" name="status" value="<?php echo $user_role[0]->level;?>" type="text">
						<input id="status_approve" name="status_approve" value="<?php echo $user_role[0]->if_approve;?>" type="text">
						<input id="status_decline" name="status_decline" value="<?php echo $user_role[0]->if_decline;?>" type="text">
