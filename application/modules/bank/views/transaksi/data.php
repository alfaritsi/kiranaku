	    		...
	    		<div class="box box-success">
	          		<div class="box-header">
						...
						<div class="btn-group pull-right">
							<button type="button" class="btn btn-success" id="sync_sap">Sync SAP</button>
						</div>
	          		</div>
	          		<!-- /.box-header -->
		          	<div class="box-body">
...
<!--modal dokumen-->
<div class="modal fade" id="modal_dokumen" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-sg" role="document">
		<div class="modal-content">
			<div class="col-sm-12">
				<div class="modal-content">
					<form role="form" class="form-transaksi-dokumen">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title" id="myModalLabel">Upload Dokumen Bank Specimen</h4>
						</div>
						<div class="modal-body">
							<div id="show_dokumen_upload"></div>
						</div>
						<div class="modal-footer">
							<input id="id_data_temp" name="id_data_temp" type="hidden">
							<input id="jenis_pengajuan" name="jenis_pengajuan" type="hidden">
							<button id="btn_save_dokumen" type="button" class="btn btn-primary" name="btn_save_dokumen">Submit</button>
						</div>
					</form>
				</div>
			</div>
					...
					<form role="form" class="form-transaksi-coa">
						...
						<div class="modal-body">
							...
							<div class="form-group form-control_komentar">	
								...
								<input type="text" maxlength="10" class="form-control angka_biasa" name="no_coa" id="no_coa" placeholder="No COA" required="required">
							</div>
						</div>
						<div class="modal-footer">
							<input id="id_data_temp" name="id_data_temp" type="text">
...
<script src="<?php echo base_url() ?>assets/apps/js/bank/transaksi/data.js"></script>
