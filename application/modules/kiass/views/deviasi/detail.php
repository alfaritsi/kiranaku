			...
			<div class="col-sm-12">
				<div class="box box-success page-wrapper">
					<div class="box-header with-border">
						<h3 class="box-title pull-left"><strong>Detail Pengajuan Deviasi</strong></h3>
					...
					<form class="form-deviasi-scrap"
		              		...
		              		<div class="row">
		              			<div class="col-sm-12">
		              				<div class="border">
										...
										<?php if ($user->ho == 'y' || (isset($session_role[0]) && strpos($session_role[0]->nama_role, 'Finance Controller Dept Head') !== false)) { ?>
										<div class="form-group" style="margin-bottom:20px;">
											<label>Lampiran Finance Controller</label>
											<div class="input-group" style="width: 100%;">
												<input type="text" class="form-control caption_file" name="caption_lampiran_fincon" readonly="readonly">
												<div class="input-group-btn">
													<input type="file" name="lampiran_fincon[]" class="form-control file-fincon fincon upload_file berkas" style="display:none;">
													<button type="button" class="btn btn-default fincon btn-flat btn_upload_file" data-title="Upload" disabled><i class="fa fa-upload"></i></button>
												</div>
												<div class="input-group-btn">
						...
						<div class="box-footer">
							...
							<?php
								if (isset($approval)) {
									if ($approval->if_approve_capex !== NULL)
										echo '<button type="button" class="btn btn-success btn_fincon hide" name="btn_fincon">Submit dan Approve</button>';
...
<script src="<?php echo base_url() ?>assets/apps/js/kiass/deviasi/detail.js"></script>
