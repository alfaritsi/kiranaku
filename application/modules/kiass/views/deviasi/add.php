			...
			<div class="col-sm-12">
				<div class="box box-success page-wrapper">
					<div class="box-header with-border">
						<h3 class="box-title pull-left"><strong>Form Pengajuan Deviasi</strong></h3>
						<!-- <button type="button"
								class="btn btn-sm btn-success pull-right change-um">Analisa Harga
						</button> -->
					</div>
...
<script src="<?php echo base_url() ?>assets/apps/js/kiass/deviasi/add.js"></script>
