							...
							<tbody>
								<?php
									foreach ($list as $dt) {
										...
										if(($session_role[0]->level == $dt->status)){
											...
											if($dt->status == 'finish' && $session_role[0]->level == '1' && $dt->count_deviasi == '0'){
											// if($dt->view_status == 'finish'){
...
<script src="<?php echo base_url() ?>assets/apps/js/kiass/transaksi/approval.js"></script>
