			...
			<div class="col-sm-12">
				<div class="box box-success page-wrapper">
					<div class="box-header with-border">
						<h3 class="box-title pull-left"><strong>Edit Pengajuan Penjualan</strong></h3>
														...
														<table class="table table-hover table-form">
															<thead>
																<tr>
																	...
																	<!-- <th class="text-center calon_tabel1 calon1" colspan="2">Calon Pembeli 1 <button type="button" value="1" class="btn btn-default pull-right btn-sm dels-input"><i class="fa fa-times"></i></button></th>
																	<th class="text-center calon_tabel1 calon2" colspan="2">Calon Pembeli 2 <button type="button" value="2" class="btn btn-default pull-right btn-sm dels-input"><i class="fa fa-times"></i></button></th>
																	<th class="text-center calon_tabel1 calon3" colspan="2">Calon Pembeli 3 <button type="button" value="3" class="btn btn-default pull-right btn-sm dels-input"><i class="fa fa-times"></i></button></th> -->
															...
															<tbody>
																<tr class="input-table-row1 row1" data-row="1" data-tabel="1">
																	...
																	<td class="text-center mw200"><select name='kode_material_tabel1_row1'class='form-control select-material autocomplete' required data-test="kode_material_tabel1_row1" data-allowclear="true"><option></option></select>
																	<input type='hidden' name='id_row_analisa_tabel1_row1'>
																	</td>
																	...
																	<td class="text-center mw200">
																		<div class="input-group">
																			<input type="text" class="form-control mw150 acc input-acc" name='kode_asset_tabel1_row1' readonly>
																			<div class="input-group-addon">-</div>
																			<input type="text" class="form-control mw40 acc input-acc" name='sno_tabel1_row1' readonly>
																		</div>
																	</td>
																	<td class="text-center mw200">
																		<textarea name="deskripsi_asset_tabel1_row1" class="form-control col-sm-12 acc" readonly></textarea>
																	</td>
																	<td class="text-center mw150"><input type="text" class="form-control col-sm-12 acc" name='cap_date_tabel1_row1' readonly></td>
																	<td class="text-center mw200">
																		<div class="input-group">
																			<div class="input-group-addon">Rp</div>
																			<input type="text" class="text-center form-control col-sm-12 nbv angka acc" readonly name="nbv_tabel1_row1">
																		</div>
																	</td>
																	...
																	<td class="text-center mw200">
																		<div class="input-group">
																			...
																			<input type='hidden' name='id_calon_pembeli_tabel1_row1_calon1'>
																		</div>
																	</td>
																	<td class="text-center mw200">
																		<div class="input-group">
																	...
																	<td class="text-center mw200">
																		<div class="input-group">
																			...
																			<input type='hidden' name='id_calon_pembeli_tabel1_row1_calon2'>
																		</div>
																	</td>
																	<td class="text-center mw200">
																		<div class="input-group">
...
<script src="<?php echo base_url() ?>assets/apps/js/kiass/transaksi/edit.js?<?php echo time(); ?>"></script>
